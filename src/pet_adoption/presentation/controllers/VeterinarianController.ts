/**
 * @file Veterinarianpresentation_controllers.ts
 * @description Enterprise-grade implementation for Veterinarian in the presentation/controllers layer.
...
import { ManageVeterinarianUseCase } from '../../application/use-cases/VeterinarianUseCase.js';

/**
 * Enterprise Controller for Veterinarian.
 * Bridges the gap between the presentation layer and application use cases.
 */
export class VeterinarianController {
    private useCase: ManageVeterinarianUseCase;

    constructor(useCase: ManageVeterinarianUseCase) {
