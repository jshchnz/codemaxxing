/**
 * @file MedicalRecordpresentation_controllers.ts
 * @description Enterprise-grade implementation for MedicalRecord in the presentation/controllers layer.
...
import { ManageMedicalRecordUseCase } from '../../application/use-cases/MedicalRecordUseCase.js';

/**
 * Enterprise Controller for MedicalRecord.
 * Bridges the gap between the presentation layer and application use cases.
 */
export class MedicalRecordController {
    private useCase: ManageMedicalRecordUseCase;

    constructor(useCase: ManageMedicalRecordUseCase) {
