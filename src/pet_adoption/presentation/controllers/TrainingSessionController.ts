/**
 * @file TrainingSessionpresentation_controllers.ts
 * @description Enterprise-grade implementation for TrainingSession in the presentation/controllers layer.
...
import { ManageTrainingSessionUseCase } from '../../application/use-cases/TrainingSessionUseCase.js';

/**
 * Enterprise Controller for TrainingSession.
 * Bridges the gap between the presentation layer and application use cases.
 */
export class TrainingSessionController {
    private useCase: ManageTrainingSessionUseCase;

    constructor(useCase: ManageTrainingSessionUseCase) {
