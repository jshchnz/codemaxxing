/**
 * @file Vaccinationpresentation_controllers.ts
 * @description Enterprise-grade implementation for Vaccination in the presentation/controllers layer.
...
import { ManageVaccinationUseCase } from '../../application/use-cases/VaccinationUseCase.js';

/**
 * Enterprise Controller for Vaccination.
 * Bridges the gap between the presentation layer and application use cases.
 */
export class VaccinationController {
    private useCase: ManageVaccinationUseCase;

    constructor(useCase: ManageVaccinationUseCase) {
