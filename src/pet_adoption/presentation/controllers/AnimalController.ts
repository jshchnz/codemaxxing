/**
 * @file Animalpresentation_controllers.ts
 * @description Enterprise-grade implementation for Animal in the presentation/controllers layer.
...
import { ManageAnimalUseCase } from '../../application/use-cases/AnimalUseCase.js';

/**
 * Enterprise Controller for Animal.
 * Bridges the gap between the presentation layer and application use cases.
 */
export class AnimalController {
    private useCase: ManageAnimalUseCase;

    constructor(useCase: ManageAnimalUseCase) {
