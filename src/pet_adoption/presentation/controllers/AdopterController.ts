/**
 * @file Adopterpresentation_controllers.ts
 * @description Enterprise-grade implementation for Adopter in the presentation/controllers layer.
...
import { ManageAdopterUseCase } from '../../application/use-cases/AdopterUseCase.js';

/**
 * Enterprise Controller for Adopter.
 * Bridges the gap between the presentation layer and application use cases.
 */
export class AdopterController {
    private useCase: ManageAdopterUseCase;

    constructor(useCase: ManageAdopterUseCase) {
