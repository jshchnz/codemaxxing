/**
 * @file AdoptionApplicationapplication_use-cases.ts
 * @description Enterprise-grade implementation for AdoptionApplication in the application/use-cases layer.
...
import { IAdoptionApplication, AdoptionApplication } from '../../domain/models/AdoptionApplication.js';

/**
 * Enterprise Use Case for managing AdoptionApplication operations.
 * Orchestrates business rules independently of frameworks.
 */
export class ManageAdoptionApplicationUseCase {
    private repository: IAdoptionApplicationRepository;

    constructor(repository: IAdoptionApplicationRepository) {
        this.repository = repository;
    }

    public async executeCreate(id: string): Promise<IAdoptionApplication> {
        const newEntity = new AdoptionApplication(id);
        await this.repository.save(newEntity);
        return newEntity;
    }

    public async executeFind(id: string): Promise<IAdoptionApplication | null> {
