/**
 * @file Animalapplication_use-cases.ts
 * @description Enterprise-grade implementation for Animal in the application/use-cases layer.
...
import { IAnimal, Animal } from '../../domain/models/Animal.js';

/**
 * Enterprise Use Case for managing Animal operations.
 * Orchestrates business rules independently of frameworks.
 */
export class ManageAnimalUseCase {
    ...
    public async executeCreate(id: string): Promise<IAnimal> {
        const newEntity = new Animal(id);
        await this.repository.save(newEntity);
        return newEntity;
    }

    public async executeFind(id: string): Promise<IAnimal | null> {
