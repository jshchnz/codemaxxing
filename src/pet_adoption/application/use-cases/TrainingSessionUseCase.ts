/**
 * @file TrainingSessionapplication_use-cases.ts
 * @description Enterprise-grade implementation for TrainingSession in the application/use-cases layer.
...
import { ITrainingSessionRepository } from '../../domain/repositories/ITrainingSessionRepository.js';
import { ITrainingSession, TrainingSession } from '../../domain/models/TrainingSession.js';

/**
 * Enterprise Use Case for managing TrainingSession operations.
 * Orchestrates business rules independently of frameworks.
 */
export class ManageTrainingSessionUseCase {
    private repository: ITrainingSessionRepository;

    constructor(repository: ITrainingSessionRepository) {
        this.repository = repository;
    }

    public async executeCreate(id: string): Promise<ITrainingSession> {
        const newEntity = new TrainingSession(id);
        await this.repository.save(newEntity);
        return newEntity;
    }

    public async executeFind(id: string): Promise<ITrainingSession | null> {
