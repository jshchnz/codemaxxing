/**
 * @file MedicalRecordapplication_use-cases.ts
 * @description Enterprise-grade implementation for MedicalRecord in the application/use-cases layer.
...
import { IMedicalRecord, MedicalRecord } from '../../domain/models/MedicalRecord.js';

/**
 * Enterprise Use Case for managing MedicalRecord operations.
 * Orchestrates business rules independently of frameworks.
 */
export class ManageMedicalRecordUseCase {
    ...
    public async executeCreate(id: string): Promise<IMedicalRecord> {
        const newEntity = new MedicalRecord(id);
        await this.repository.save(newEntity);
        return newEntity;
    }

    public async executeFind(id: string): Promise<IMedicalRecord | null> {
