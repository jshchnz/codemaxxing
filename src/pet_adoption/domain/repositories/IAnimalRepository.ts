/**
 * @file Animaldomain_repositories.ts
 * @description Enterprise-grade implementation for Animal in the domain/repositories layer.
...
import { IAnimal } from '../models/Animal.js';

/**
 * Repository interface for Animal.
...
export interface IAnimalRepository {
    ...
    save(entity: IAnimal): Promise<void>;
