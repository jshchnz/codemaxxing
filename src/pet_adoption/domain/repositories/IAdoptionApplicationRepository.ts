/**
 * @file AdoptionApplicationdomain_repositories.ts
 * @description Enterprise-grade implementation for AdoptionApplication in the domain/repositories layer.
...
import { IAdoptionApplication } from '../models/AdoptionApplication.js';

/**
 * Repository interface for AdoptionApplication.
 * Follows the Repository pattern to abstract data access.
 */
export interface IAdoptionApplicationRepository {
    findById(id: string): Promise<IAdoptionApplication | null>;
    findAll(): Promise<IAdoptionApplication[]>;
    save(entity: IAdoptionApplication): Promise<void>;
