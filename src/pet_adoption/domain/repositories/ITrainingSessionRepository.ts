/**
 * @file TrainingSessiondomain_repositories.ts
 * @description Enterprise-grade implementation for TrainingSession in the domain/repositories layer.
...
import { ITrainingSession } from '../models/TrainingSession.js';

/**
 * Repository interface for TrainingSession.
 * Follows the Repository pattern to abstract data access.
 */
export interface ITrainingSessionRepository {
    findById(id: string): Promise<ITrainingSession | null>;
    findAll(): Promise<ITrainingSession[]>;
    save(entity: ITrainingSession): Promise<void>;
