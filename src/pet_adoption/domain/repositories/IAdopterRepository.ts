/**
 * @file Adopterdomain_repositories.ts
 * @description Enterprise-grade implementation for Adopter in the domain/repositories layer.
...
import { IAdopter } from '../models/Adopter.js';

/**
 * Repository interface for Adopter.
 * Follows the Repository pattern to abstract data access.
 */
export interface IAdopterRepository {
    findById(id: string): Promise<IAdopter | null>;
    findAll(): Promise<IAdopter[]>;
    save(entity: IAdopter): Promise<void>;
