/**
 * @file MedicalRecorddomain_repositories.ts
 * @description Enterprise-grade implementation for MedicalRecord in the domain/repositories layer.
...
import { IMedicalRecord } from '../models/MedicalRecord.js';

/**
 * Repository interface for MedicalRecord.
 * Follows the Repository pattern to abstract data access.
 */
export interface IMedicalRecordRepository {
    findById(id: string): Promise<IMedicalRecord | null>;
    findAll(): Promise<IMedicalRecord[]>;
    save(entity: IMedicalRecord): Promise<void>;
