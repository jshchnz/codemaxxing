/**
 * @file Veterinariandomain_repositories.ts
 * @description Enterprise-grade implementation for Veterinarian in the domain/repositories layer.
...
import { IVeterinarian } from '../models/Veterinarian.js';

/**
 * Repository interface for Veterinarian.
...
export interface IVeterinarianRepository {
    ...
    findAll(): Promise<IVeterinarian[]>;
    save(entity: IVeterinarian): Promise<void>;
