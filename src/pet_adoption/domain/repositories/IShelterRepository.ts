/**
 * @file Shelterdomain_repositories.ts
 * @description Enterprise-grade implementation for Shelter in the domain/repositories layer.
...
import { IShelter } from '../models/Shelter.js';

/**
 * Repository interface for Shelter.
 * Follows the Repository pattern to abstract data access.
 */
export interface IShelterRepository {
    findById(id: string): Promise<IShelter | null>;
    findAll(): Promise<IShelter[]>;
    save(entity: IShelter): Promise<void>;
