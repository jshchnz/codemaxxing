/**
 * @file DietPlandomain_repositories.ts
 * @description Enterprise-grade implementation for DietPlan in the domain/repositories layer.
...
import { IDietPlan } from '../models/DietPlan.js';

/**
 * Repository interface for DietPlan.
...
export interface IDietPlanRepository {
    ...
    findAll(): Promise<IDietPlan[]>;
    save(entity: IDietPlan): Promise<void>;
