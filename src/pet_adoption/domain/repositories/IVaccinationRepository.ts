/**
 * @file Vaccinationdomain_repositories.ts
 * @description Enterprise-grade implementation for Vaccination in the domain/repositories layer.
...
import { IVaccination } from '../models/Vaccination.js';

/**
 * Repository interface for Vaccination.
 * Follows the Repository pattern to abstract data access.
 */
export interface IVaccinationRepository {
    findById(id: string): Promise<IVaccination | null>;
    findAll(): Promise<IVaccination[]>;
    save(entity: IVaccination): Promise<void>;
