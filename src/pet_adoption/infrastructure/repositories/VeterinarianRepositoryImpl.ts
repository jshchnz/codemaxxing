/**
 * @file Veterinarianinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for Veterinarian in the infrastructure/repositories layer.
...
import { IVeterinarianRepository } from '../../domain/repositories/IVeterinarianRepository.js';
import { IVeterinarian } from '../../domain/models/Veterinarian.js';

/**
 * Concrete implementation of IVeterinarianRepository using abstract infrastructure.
 */
export class VeterinarianRepositoryImpl implements IVeterinarianRepository {
    private storage: Map<string, IVeterinarian> = new Map();

    public async findById(id: string): Promise<IVeterinarian | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<IVeterinarian[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: IVeterinarian): Promise<void> {
