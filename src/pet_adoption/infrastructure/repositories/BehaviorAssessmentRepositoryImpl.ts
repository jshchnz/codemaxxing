/**
 * @file BehaviorAssessmentinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for BehaviorAssessment in the infrastructure/repositories layer.
...
import { IBehaviorAssessmentRepository } from '../../domain/repositories/IBehaviorAssessmentRepository.js';
import { IBehaviorAssessment } from '../../domain/models/BehaviorAssessment.js';

/**
 * Concrete implementation of IBehaviorAssessmentRepository using abstract infrastructure.
 */
export class BehaviorAssessmentRepositoryImpl implements IBehaviorAssessmentRepository {
    private storage: Map<string, IBehaviorAssessment> = new Map();

    public async findById(id: string): Promise<IBehaviorAssessment | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<IBehaviorAssessment[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: IBehaviorAssessment): Promise<void> {
