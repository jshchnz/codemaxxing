/**
 * @file Vaccinationinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for Vaccination in the infrastructure/repositories layer.
...
import { IVaccinationRepository } from '../../domain/repositories/IVaccinationRepository.js';
import { IVaccination } from '../../domain/models/Vaccination.js';

/**
 * Concrete implementation of IVaccinationRepository using abstract infrastructure.
 */
export class VaccinationRepositoryImpl implements IVaccinationRepository {
    private storage: Map<string, IVaccination> = new Map();

    public async findById(id: string): Promise<IVaccination | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<IVaccination[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: IVaccination): Promise<void> {
