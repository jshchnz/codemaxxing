/**
 * @file DietPlaninfrastructure_repositories.ts
 * @description Enterprise-grade implementation for DietPlan in the infrastructure/repositories layer.
...
import { IDietPlanRepository } from '../../domain/repositories/IDietPlanRepository.js';
import { IDietPlan } from '../../domain/models/DietPlan.js';

/**
 * Concrete implementation of IDietPlanRepository using abstract infrastructure.
 */
export class DietPlanRepositoryImpl implements IDietPlanRepository {
    private storage: Map<string, IDietPlan> = new Map();

    public async findById(id: string): Promise<IDietPlan | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<IDietPlan[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: IDietPlan): Promise<void> {
