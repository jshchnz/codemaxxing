/**
 * @file Shelterinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for Shelter in the infrastructure/repositories layer.
...
import { IShelterRepository } from '../../domain/repositories/IShelterRepository.js';
import { IShelter } from '../../domain/models/Shelter.js';

/**
 * Concrete implementation of IShelterRepository using abstract infrastructure.
 */
export class ShelterRepositoryImpl implements IShelterRepository {
    private storage: Map<string, IShelter> = new Map();

    public async findById(id: string): Promise<IShelter | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<IShelter[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: IShelter): Promise<void> {
