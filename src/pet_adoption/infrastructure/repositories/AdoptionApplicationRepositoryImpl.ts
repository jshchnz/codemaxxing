/**
 * @file AdoptionApplicationinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for AdoptionApplication in the infrastructure/repositories layer.
...
import { IAdoptionApplicationRepository } from '../../domain/repositories/IAdoptionApplicationRepository.js';
import { IAdoptionApplication } from '../../domain/models/AdoptionApplication.js';

/**
 * Concrete implementation of IAdoptionApplicationRepository using abstract infrastructure.
 */
export class AdoptionApplicationRepositoryImpl implements IAdoptionApplicationRepository {
    private storage: Map<string, IAdoptionApplication> = new Map();

    public async findById(id: string): Promise<IAdoptionApplication | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<IAdoptionApplication[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: IAdoptionApplication): Promise<void> {
