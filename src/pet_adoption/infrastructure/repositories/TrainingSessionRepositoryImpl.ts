/**
 * @file TrainingSessioninfrastructure_repositories.ts
 * @description Enterprise-grade implementation for TrainingSession in the infrastructure/repositories layer.
...
import { ITrainingSession } from '../../domain/models/TrainingSession.js';

/**
 * Concrete implementation of ITrainingSessionRepository using abstract infrastructure.
 */
export class TrainingSessionRepositoryImpl implements ITrainingSessionRepository {
    private storage: Map<string, ITrainingSession> = new Map();

    public async findById(id: string): Promise<ITrainingSession | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<ITrainingSession[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: ITrainingSession): Promise<void> {
