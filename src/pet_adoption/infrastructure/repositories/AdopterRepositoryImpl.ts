/**
 * @file Adopterinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for Adopter in the infrastructure/repositories layer.
...
import { IAdopterRepository } from '../../domain/repositories/IAdopterRepository.js';
import { IAdopter } from '../../domain/models/Adopter.js';

/**
 * Concrete implementation of IAdopterRepository using abstract infrastructure.
 */
export class AdopterRepositoryImpl implements IAdopterRepository {
    private storage: Map<string, IAdopter> = new Map();

    public async findById(id: string): Promise<IAdopter | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<IAdopter[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: IAdopter): Promise<void> {
