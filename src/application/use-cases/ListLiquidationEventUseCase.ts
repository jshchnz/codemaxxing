 ...
 * ============================================================================
 *
 * File: ListLiquidationEventUseCase.ts
 * Description: Use case for List LiquidationEvent
 *
...
/**
 * Enterprise Use Case for List LiquidationEvent.
 * Encapsulates the business logic for this operation.
 */
export class ListLiquidationEventUseCase {
