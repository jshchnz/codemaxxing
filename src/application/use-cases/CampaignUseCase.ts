/**
 * @file Campaignapplication_use-cases.ts
 * @description Enterprise-grade implementation for Campaign in the application/use-cases layer.
...
import { ICampaign, Campaign } from '../../domain/models/Campaign';

/**
 * Enterprise Use Case for managing Campaign operations in campaigns.
...
export class ManageCampaignUseCase {
    ...
    public async executeCreate(id: string, name: string): Promise<ICampaign> {
        const newEntity = new Campaign(id, name);
        await this.repository.save(newEntity);
        return newEntity;
    }

    public async executeFind(id: string): Promise<ICampaign | null> {
