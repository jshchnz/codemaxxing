 ...
 * ============================================================================
 *
 * File: CreateLiquidationEventUseCase.ts
 * Description: Use case for Create LiquidationEvent
 *
...
/**
 * Enterprise Use Case for Create LiquidationEvent.
 * Encapsulates the business logic for this operation.
 */
export class CreateLiquidationEventUseCase {
