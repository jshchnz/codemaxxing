/**
 * @file Classapplication_use-cases.ts
 * @description Enterprise-grade implementation for Class in the application/use-cases layer.
...
import { IClass, Class } from '../../domain/models/Class';

/**
 * Enterprise Use Case for managing Class operations in campaigns.
...
export class ManageClassUseCase {
    ...
    public async executeCreate(id: string, name: string): Promise<IClass> {
        const newEntity = new Class(id, name);
        await this.repository.save(newEntity);
        return newEntity;
    }

    public async executeFind(id: string): Promise<IClass | null> {
