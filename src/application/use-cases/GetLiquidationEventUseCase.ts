 ...
 * ============================================================================
 *
 * File: GetLiquidationEventUseCase.ts
 * Description: Use case for Get LiquidationEvent
 *
...
/**
 * Enterprise Use Case for Get LiquidationEvent.
 * Encapsulates the business logic for this operation.
 */
export class GetLiquidationEventUseCase {
