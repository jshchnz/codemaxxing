 ...
 * ============================================================================
 *
 * File: DeleteFuturesContractUseCase.ts
 * Description: Use case for Delete FuturesContract
 *
...
/**
 * Enterprise Use Case for Delete FuturesContract.
 * Encapsulates the business logic for this operation.
 */
export class DeleteFuturesContractUseCase {
