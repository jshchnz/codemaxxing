/**
 * @file Journalapplication_use-cases.ts
 * @description Enterprise-grade implementation for Journal in the application/use-cases layer.
...
import { IJournal, Journal } from '../../domain/models/Journal';

/**
 * Enterprise Use Case for managing Journal operations in campaigns.
...
export class ManageJournalUseCase {
    ...
    public async executeCreate(id: string, name: string): Promise<IJournal> {
        const newEntity = new Journal(id, name);
        await this.repository.save(newEntity);
        return newEntity;
    }

    public async executeFind(id: string): Promise<IJournal | null> {
