 ...
 * ============================================================================
 *
 * File: ListComplianceRecordUseCase.ts
 * Description: Use case for List ComplianceRecord
 *
...
/**
 * Enterprise Use Case for List ComplianceRecord.
 * Encapsulates the business logic for this operation.
 */
export class ListComplianceRecordUseCase {
