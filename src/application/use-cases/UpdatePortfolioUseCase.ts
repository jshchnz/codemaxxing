 ...
 * ============================================================================
 *
 * File: UpdatePortfolioUseCase.ts
 * Description: Use case for Update Portfolio
 *
...
import { IPortfolioModel, PortfolioModel } from '../../domain/models/PortfolioModel.js';

/**
 * Enterprise Use Case for Update Portfolio.
...
export class UpdatePortfolioUseCase {
     ...
     * @param {IPortfolioRepository} repository - The injected repository
     */
