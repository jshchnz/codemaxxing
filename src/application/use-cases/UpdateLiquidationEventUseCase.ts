 ...
 * ============================================================================
 *
 * File: UpdateLiquidationEventUseCase.ts
 * Description: Use case for Update LiquidationEvent
 *
...
/**
 * Enterprise Use Case for Update LiquidationEvent.
 * Encapsulates the business logic for this operation.
 */
export class UpdateLiquidationEventUseCase {
