 ...
 * ============================================================================
 *
 * File: DeleteYieldFarmingPositionUseCase.ts
 * Description: Use case for Delete YieldFarmingPosition
 *
...
/**
 * Enterprise Use Case for Delete YieldFarmingPosition.
 * Encapsulates the business logic for this operation.
 */
export class DeleteYieldFarmingPositionUseCase {
