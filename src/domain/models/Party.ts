/**
 * @file Partydomain_models.ts
 * @description Enterprise-grade implementation for Party in the domain/models layer.
...
/**
 * The concrete implementation of the Party domain model.
