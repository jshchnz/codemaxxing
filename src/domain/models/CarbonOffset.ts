/**
 * @file CarbonOffsetdomain_models.ts
 * @description Enterprise-grade implementation for CarbonOffset in the domain/models layer.
...
export interface ICarbonOffset {
    getId(): string;
    getCreatedAt(): Date;
    getUpdatedAt(): Date;
}
...
/**
 * The concrete implementation of the CarbonOffset domain model.
 * Incorporates the Observer pattern for domain events.
 */
export class CarbonOffset implements ICarbonOffset {
    private id: string;
