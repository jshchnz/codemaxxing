/**
 * @file Analyticsdomain_repositories.ts
 * @description Enterprise-grade implementation for Analytics in the domain/repositories layer.
...
export interface IAnalyticsRepository {
    findById(id: string): Promise<IAnalytics | null>;
    findAll(): Promise<IAnalytics[]>;
    save(entity: IAnalytics): Promise<void>;
