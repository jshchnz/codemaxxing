/**
 * @file Skilldomain_repositories.ts
 * @description Enterprise-grade implementation for Skill in the domain/repositories layer.
...
export interface ISkillRepository {
    ...
    save(entity: ISkill): Promise<void>;
    delete(id: string): Promise<void>;
    findByName(name: string): Promise<ISkill[]>;
}
