/**
 * @file Puzzledomain_repositories.ts
 * @description Enterprise-grade implementation for Puzzle in the domain/repositories layer.
...
/**
 * Repository interface for Puzzle.
 * Follows the Repository pattern to abstract data access.
 */
export interface IPuzzleRepository {
    findById(id: string): Promise<IPuzzle | null>;
    findAll(): Promise<IPuzzle[]>;
    save(entity: IPuzzle): Promise<void>;
    delete(id: string): Promise<void>;
    findByName(name: string): Promise<IPuzzle[]>;
}
