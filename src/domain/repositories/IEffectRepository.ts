/**
 * @file Effectdomain_repositories.ts
 * @description Enterprise-grade implementation for Effect in the domain/repositories layer.
...
/**
 * Repository interface for Effect.
 * Follows the Repository pattern to abstract data access.
 */
export interface IEffectRepository {
    findById(id: string): Promise<IEffect | null>;
    findAll(): Promise<IEffect[]>;
    save(entity: IEffect): Promise<void>;
    delete(id: string): Promise<void>;
    findByName(name: string): Promise<IEffect[]>;
}
