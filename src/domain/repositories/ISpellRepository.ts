/**
 * @file Spelldomain_repositories.ts
 * @description Enterprise-grade implementation for Spell in the domain/repositories layer.
...
export interface ISpellRepository {
    findById(id: string): Promise<ISpell | null>;
    findAll(): Promise<ISpell[]>;
    save(entity: ISpell): Promise<void>;
