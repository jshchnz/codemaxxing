/**
 * @file Conditiondomain_repositories.ts
 * @description Enterprise-grade implementation for Condition in the domain/repositories layer.
...
export interface IConditionRepository {
    findById(id: string): Promise<ICondition | null>;
    findAll(): Promise<ICondition[]>;
    save(entity: ICondition): Promise<void>;
    delete(id: string): Promise<void>;
    findByName(name: string): Promise<ICondition[]>;
}
