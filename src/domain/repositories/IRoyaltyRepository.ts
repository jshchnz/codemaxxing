/**
 * @file Royaltydomain_repositories.ts
 * @description Enterprise-grade implementation for Royalty in the domain/repositories layer.
...
import { IRoyalty } from '../models/Royalty';

/**
 * Repository interface for Royalty.
 * Follows the Repository pattern to abstract data access.
 */
export interface IRoyaltyRepository {
    findById(id: string): Promise<IRoyalty | null>;
    findAll(): Promise<IRoyalty[]>;
    save(entity: IRoyalty): Promise<void>;
