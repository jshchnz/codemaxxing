/**
 * @file Characterdomain_repositories.ts
 * @description Enterprise-grade implementation for Character in the domain/repositories layer.
...
/**
 * Repository interface for Character.
...
export interface ICharacterRepository {
    ...
    save(entity: ICharacter): Promise<void>;
