/**
 * @file Chatdomain_repositories.ts
 * @description Enterprise-grade implementation for Chat in the domain/repositories layer.
...
export interface IChatRepository {
    ...
    save(entity: IChat): Promise<void>;
    delete(id: string): Promise<void>;
    findByName(name: string): Promise<IChat[]>;
}
