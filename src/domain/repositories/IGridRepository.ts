/**
 * @file Griddomain_repositories.ts
 * @description Enterprise-grade implementation for Grid in the domain/repositories layer.
...
/**
 * Repository interface for Grid.
 * Follows the Repository pattern to abstract data access.
 */
export interface IGridRepository {
    findById(id: string): Promise<IGrid | null>;
    findAll(): Promise<IGrid[]>;
    save(entity: IGrid): Promise<void>;
    delete(id: string): Promise<void>;
    findByName(name: string): Promise<IGrid[]>;
}
