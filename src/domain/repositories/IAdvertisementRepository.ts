/**
 * @file Advertisementdomain_repositories.ts
 * @description Enterprise-grade implementation for Advertisement in the domain/repositories layer.
...
/**
 * Repository interface for Advertisement.
...
export interface IAdvertisementRepository {
    ...
    save(entity: IAdvertisement): Promise<void>;
