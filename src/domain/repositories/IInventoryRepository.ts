/**
 * @file Inventorydomain_repositories.ts
 * @description Enterprise-grade implementation for Inventory in the domain/repositories layer.
...
export interface IInventoryRepository {
    ...
    save(entity: IInventory): Promise<void>;
    delete(id: string): Promise<void>;
    findByName(name: string): Promise<IInventory[]>;
}
