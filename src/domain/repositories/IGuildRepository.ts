/**
 * @file Guilddomain_repositories.ts
 * @description Enterprise-grade implementation for Guild in the domain/repositories layer.
...
/**
 * Repository interface for Guild.
 * Follows the Repository pattern to abstract data access.
 */
export interface IGuildRepository {
    findById(id: string): Promise<IGuild | null>;
    findAll(): Promise<IGuild[]>;
    save(entity: IGuild): Promise<void>;
