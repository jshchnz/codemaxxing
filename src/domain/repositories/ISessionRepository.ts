/**
 * @file Sessiondomain_repositories.ts
 * @description Enterprise-grade implementation for Session in the domain/repositories layer.
...
export interface ISessionRepository {
    ...
    save(entity: ISession): Promise<void>;
    delete(id: string): Promise<void>;
    findByName(name: string): Promise<ISession[]>;
}
