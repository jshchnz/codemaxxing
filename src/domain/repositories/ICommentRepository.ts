/**
 * @file Commentdomain_repositories.ts
 * @description Enterprise-grade implementation for Comment in the domain/repositories layer.
...
export interface ICommentRepository {
    ...
    save(entity: IComment): Promise<void>;
