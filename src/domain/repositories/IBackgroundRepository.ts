/**
 * @file Backgrounddomain_repositories.ts
 * @description Enterprise-grade implementation for Background in the domain/repositories layer.
...
/**
 * Repository interface for Background.
 * Follows the Repository pattern to abstract data access.
 */
export interface IBackgroundRepository {
    findById(id: string): Promise<IBackground | null>;
    findAll(): Promise<IBackground[]>;
    save(entity: IBackground): Promise<void>;
    delete(id: string): Promise<void>;
    findByName(name: string): Promise<IBackground[]>;
}
