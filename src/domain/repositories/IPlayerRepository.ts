/**
 * @file Playerdomain_repositories.ts
 * @description Enterprise-grade implementation for Player in the domain/repositories layer.
...
/**
 * Repository interface for Player.
...
export interface IPlayerRepository {
    ...
    save(entity: IPlayer): Promise<void>;
