/**
 * @file Racedomain_repositories.ts
 * @description Enterprise-grade implementation for Race in the domain/repositories layer.
...
export interface IRaceRepository {
    ...
    save(entity: IRace): Promise<void>;
    delete(id: string): Promise<void>;
    findByName(name: string): Promise<IRace[]>;
}
