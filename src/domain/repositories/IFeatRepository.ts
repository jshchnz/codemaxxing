/**
 * @file Featdomain_repositories.ts
 * @description Enterprise-grade implementation for Feat in the domain/repositories layer.
...
/**
 * Repository interface for Feat.
 * Follows the Repository pattern to abstract data access.
 */
export interface IFeatRepository {
    findById(id: string): Promise<IFeat | null>;
    findAll(): Promise<IFeat[]>;
    save(entity: IFeat): Promise<void>;
    delete(id: string): Promise<void>;
    findByName(name: string): Promise<IFeat[]>;
}
