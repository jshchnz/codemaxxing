/**
 * @file Genredomain_repositories.ts
 * @description Enterprise-grade implementation for Genre in the domain/repositories layer.
...
/**
 * Repository interface for Genre.
 * Follows the Repository pattern to abstract data access.
 */
export interface IGenreRepository {
    findById(id: string): Promise<IGenre | null>;
    findAll(): Promise<IGenre[]>;
    save(entity: IGenre): Promise<void>;
