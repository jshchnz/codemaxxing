/**
 * @file Searchdomain_repositories.ts
 * @description Enterprise-grade implementation for Search in the domain/repositories layer.
...
export interface ISearchRepository {
    findById(id: string): Promise<ISearch | null>;
    findAll(): Promise<ISearch[]>;
    save(entity: ISearch): Promise<void>;
