/**
 * @file Lootdomain_repositories.ts
 * @description Enterprise-grade implementation for Loot in the domain/repositories layer.
...
import { ILoot } from '../models/Loot';

/**
 * Repository interface for Loot.
 * Follows the Repository pattern to abstract data access.
 */
export interface ILootRepository {
    findById(id: string): Promise<ILoot | null>;
    findAll(): Promise<ILoot[]>;
    save(entity: ILoot): Promise<void>;
    delete(id: string): Promise<void>;
    findByName(name: string): Promise<ILoot[]>;
}
