/**
 * @file NPCdomain_repositories.ts
 * @description Enterprise-grade implementation for NPC in the domain/repositories layer.
...
export interface INPCRepository {
    ...
    save(entity: INPC): Promise<void>;
    delete(id: string): Promise<void>;
    findByName(name: string): Promise<INPC[]>;
}
