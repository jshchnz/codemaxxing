/**
 * @file Questdomain_repositories.ts
 * @description Enterprise-grade implementation for Quest in the domain/repositories layer.
...
/**
 * Repository interface for Quest.
...
export interface IQuestRepository {
    ...
    save(entity: IQuest): Promise<void>;
    delete(id: string): Promise<void>;
    findByName(name: string): Promise<IQuest[]>;
}
