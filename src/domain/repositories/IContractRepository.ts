/**
 * @file Contractdomain_repositories.ts
 * @description Enterprise-grade implementation for Contract in the domain/repositories layer.
...
export interface IContractRepository {
    ...
    save(entity: IContract): Promise<void>;
