/**
 * @file Artistdomain_repositories.ts
 * @description Enterprise-grade implementation for Artist in the domain/repositories layer.
...
/**
 * Repository interface for Artist.
...
export interface IArtistRepository {
    ...
    save(entity: IArtist): Promise<void>;
