/**
 * @file Followerdomain_repositories.ts
 * @description Enterprise-grade implementation for Follower in the domain/repositories layer.
...
/**
 * Repository interface for Follower.
 * Follows the Repository pattern to abstract data access.
 */
export interface IFollowerRepository {
    findById(id: string): Promise<IFollower | null>;
    findAll(): Promise<IFollower[]>;
    save(entity: IFollower): Promise<void>;
