/**
 * @file Encounterdomain_repositories.ts
 * @description Enterprise-grade implementation for Encounter in the domain/repositories layer.
...
import { IEncounter } from '../models/Encounter';
...
export interface IEncounterRepository {
    findById(id: string): Promise<IEncounter | null>;
    findAll(): Promise<IEncounter[]>;
    save(entity: IEncounter): Promise<void>;
    delete(id: string): Promise<void>;
    findByName(name: string): Promise<IEncounter[]>;
}
