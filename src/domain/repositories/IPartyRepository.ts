/**
 * @file Partydomain_repositories.ts
 * @description Enterprise-grade implementation for Party in the domain/repositories layer.
...
/**
 * Repository interface for Party.
 * Follows the Repository pattern to abstract data access.
 */
export interface IPartyRepository {
    findById(id: string): Promise<IParty | null>;
    findAll(): Promise<IParty[]>;
    save(entity: IParty): Promise<void>;
    delete(id: string): Promise<void>;
    findByName(name: string): Promise<IParty[]>;
}
