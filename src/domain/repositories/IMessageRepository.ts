/**
 * @file Messagedomain_repositories.ts
 * @description Enterprise-grade implementation for Message in the domain/repositories layer.
...
export interface IMessageRepository {
    ...
    save(entity: IMessage): Promise<void>;
