/**
 * @file DiceRolldomain_repositories.ts
 * @description Enterprise-grade implementation for DiceRoll in the domain/repositories layer.
...
import { IDiceRoll } from '../models/DiceRoll';

/**
 * Repository interface for DiceRoll.
 * Follows the Repository pattern to abstract data access.
 */
export interface IDiceRollRepository {
    findById(id: string): Promise<IDiceRoll | null>;
    findAll(): Promise<IDiceRoll[]>;
    save(entity: IDiceRoll): Promise<void>;
    delete(id: string): Promise<void>;
    findByName(name: string): Promise<IDiceRoll[]>;
}
