/**
 * @file Journaldomain_repositories.ts
 * @description Enterprise-grade implementation for Journal in the domain/repositories layer.
...
/**
 * Repository interface for Journal.
 * Follows the Repository pattern to abstract data access.
 */
export interface IJournalRepository {
    findById(id: string): Promise<IJournal | null>;
    findAll(): Promise<IJournal[]>;
    save(entity: IJournal): Promise<void>;
    delete(id: string): Promise<void>;
    findByName(name: string): Promise<IJournal[]>;
}
