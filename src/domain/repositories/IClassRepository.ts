/**
 * @file Classdomain_repositories.ts
 * @description Enterprise-grade implementation for Class in the domain/repositories layer.
...
export interface IClassRepository {
    ...
    save(entity: IClass): Promise<void>;
    delete(id: string): Promise<void>;
    findByName(name: string): Promise<IClass[]>;
}
