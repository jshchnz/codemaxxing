/**
 * @file Alignmentdomain_repositories.ts
 * @description Enterprise-grade implementation for Alignment in the domain/repositories layer.
...
/**
 * Repository interface for Alignment.
 * Follows the Repository pattern to abstract data access.
 */
export interface IAlignmentRepository {
    findById(id: string): Promise<IAlignment | null>;
    findAll(): Promise<IAlignment[]>;
    save(entity: IAlignment): Promise<void>;
    delete(id: string): Promise<void>;
    findByName(name: string): Promise<IAlignment[]>;
}
