/**
 * @file RuleBookdomain_repositories.ts
 * @description Enterprise-grade implementation for RuleBook in the domain/repositories layer.
...
/**
 * Repository interface for RuleBook.
 * Follows the Repository pattern to abstract data access.
 */
export interface IRuleBookRepository {
    findById(id: string): Promise<IRuleBook | null>;
    findAll(): Promise<IRuleBook[]>;
    save(entity: IRuleBook): Promise<void>;
    delete(id: string): Promise<void>;
    findByName(name: string): Promise<IRuleBook[]>;
}
