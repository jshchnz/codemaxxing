/**
 * @file Bandomain_repositories.ts
 * @description Enterprise-grade implementation for Ban in the domain/repositories layer.
...
export interface IBanRepository {
    ...
    findAll(): Promise<IBan[]>;
    save(entity: IBan): Promise<void>;
