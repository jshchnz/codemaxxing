/**
 * @file Campaigndomain_repositories.ts
 * @description Enterprise-grade implementation for Campaign in the domain/repositories layer.
...
export interface ICampaignRepository {
    ...
    findAll(): Promise<ICampaign[]>;
    save(entity: ICampaign): Promise<void>;
    delete(id: string): Promise<void>;
    findByName(name: string): Promise<ICampaign[]>;
}
