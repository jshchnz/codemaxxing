/**
 * @file Bestiarydomain_repositories.ts
 * @description Enterprise-grade implementation for Bestiary in the domain/repositories layer.
...
import { IBestiary } from '../models/Bestiary';

/**
 * Repository interface for Bestiary.
 * Follows the Repository pattern to abstract data access.
 */
export interface IBestiaryRepository {
    findById(id: string): Promise<IBestiary | null>;
    findAll(): Promise<IBestiary[]>;
    save(entity: IBestiary): Promise<void>;
    delete(id: string): Promise<void>;
    findByName(name: string): Promise<IBestiary[]>;
}
