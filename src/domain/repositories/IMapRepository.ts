/**
 * @file Mapdomain_repositories.ts
 * @description Enterprise-grade implementation for Map in the domain/repositories layer.
...
/**
 * Repository interface for Map.
 * Follows the Repository pattern to abstract data access.
 */
export interface IMapRepository {
    findById(id: string): Promise<IMap | null>;
    findAll(): Promise<IMap[]>;
    save(entity: IMap): Promise<void>;
    delete(id: string): Promise<void>;
    findByName(name: string): Promise<IMap[]>;
}
