/**
 * @file Itemdomain_repositories.ts
 * @description Enterprise-grade implementation for Item in the domain/repositories layer.
...
export interface IItemRepository {
    ...
    save(entity: IItem): Promise<void>;
    delete(id: string): Promise<void>;
    findByName(name: string): Promise<IItem[]>;
}
