/**
 * @file Characterpresentation_views.ts
 * @description Enterprise-grade implementation for Character in the presentation/views layer.
...
/**
 * Abstract Factory pattern for Character View rendering.
 * Ensures Game Masters and Players can view Character differently.
 */
export abstract class AbstractCharacterView {
    public abstract render(data: any): string;
}

export class WebCharacterView extends AbstractCharacterView {
