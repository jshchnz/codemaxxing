/**
 * @file Racepresentation_views.ts
 * @description Enterprise-grade implementation for Race in the presentation/views layer.
...
/**
 * Abstract Factory pattern for Race View rendering.
 * Ensures Game Masters and Players can view Race differently.
 */
export abstract class AbstractRaceView {
    public abstract render(data: any): string;
}

export class WebRaceView extends AbstractRaceView {
