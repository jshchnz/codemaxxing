/**
 * @file Lootpresentation_views.ts
 * @description Enterprise-grade implementation for Loot in the presentation/views layer.
...
/**
 * Abstract Factory pattern for Loot View rendering.
 * Ensures Game Masters and Players can view Loot differently.
 */
export abstract class AbstractLootView {
    public abstract render(data: any): string;
}

export class WebLootView extends AbstractLootView {
