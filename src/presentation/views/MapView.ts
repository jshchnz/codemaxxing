/**
 * @file Mappresentation_views.ts
 * @description Enterprise-grade implementation for Map in the presentation/views layer.
...
/**
 * Abstract Factory pattern for Map View rendering.
 * Ensures Game Masters and Players can view Map differently.
 */
export abstract class AbstractMapView {
    public abstract render(data: any): string;
}

export class WebMapView extends AbstractMapView {
