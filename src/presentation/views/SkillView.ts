/**
 * @file Skillpresentation_views.ts
 * @description Enterprise-grade implementation for Skill in the presentation/views layer.
...
/**
 * Abstract Factory pattern for Skill View rendering.
 * Ensures Game Masters and Players can view Skill differently.
 */
export abstract class AbstractSkillView {
    public abstract render(data: any): string;
}

export class WebSkillView extends AbstractSkillView {
