/**
 * @file Classpresentation_views.ts
 * @description Enterprise-grade implementation for Class in the presentation/views layer.
...
/**
 * Abstract Factory pattern for Class View rendering.
 * Ensures Game Masters and Players can view Class differently.
 */
export abstract class AbstractClassView {
    public abstract render(data: any): string;
}

export class WebClassView extends AbstractClassView {
