/**
 * @file Campaignpresentation_views.ts
 * @description Enterprise-grade implementation for Campaign in the presentation/views layer.
...
/**
 * Abstract Factory pattern for Campaign View rendering.
 * Ensures Game Masters and Players can view Campaign differently.
 */
export abstract class AbstractCampaignView {
    public abstract render(data: any): string;
}

export class WebCampaignView extends AbstractCampaignView {
