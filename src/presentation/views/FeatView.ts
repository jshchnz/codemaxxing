/**
 * @file Featpresentation_views.ts
 * @description Enterprise-grade implementation for Feat in the presentation/views layer.
...
/**
 * Abstract Factory pattern for Feat View rendering.
 * Ensures Game Masters and Players can view Feat differently.
 */
export abstract class AbstractFeatView {
    public abstract render(data: any): string;
}

export class WebFeatView extends AbstractFeatView {
