/**
 * @file Effectpresentation_views.ts
 * @description Enterprise-grade implementation for Effect in the presentation/views layer.
...
/**
 * Abstract Factory pattern for Effect View rendering.
 * Ensures Game Masters and Players can view Effect differently.
 */
export abstract class AbstractEffectView {
    public abstract render(data: any): string;
}

export class WebEffectView extends AbstractEffectView {
