/**
 * @file Partypresentation_views.ts
 * @description Enterprise-grade implementation for Party in the presentation/views layer.
...
/**
 * Abstract Factory pattern for Party View rendering.
 * Ensures Game Masters and Players can view Party differently.
 */
export abstract class AbstractPartyView {
    public abstract render(data: any): string;
}

export class WebPartyView extends AbstractPartyView {
