/**
 * @file Chatpresentation_views.ts
 * @description Enterprise-grade implementation for Chat in the presentation/views layer.
...
/**
 * Abstract Factory pattern for Chat View rendering.
 * Ensures Game Masters and Players can view Chat differently.
 */
export abstract class AbstractChatView {
    public abstract render(data: any): string;
}

export class WebChatView extends AbstractChatView {
