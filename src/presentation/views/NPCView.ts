/**
 * @file NPCpresentation_views.ts
 * @description Enterprise-grade implementation for NPC in the presentation/views layer.
...
/**
 * Abstract Factory pattern for NPC View rendering.
 * Ensures Game Masters and Players can view NPC differently.
 */
export abstract class AbstractNPCView {
    public abstract render(data: any): string;
}

export class WebNPCView extends AbstractNPCView {
