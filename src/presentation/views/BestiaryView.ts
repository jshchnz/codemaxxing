/**
 * @file Bestiarypresentation_views.ts
 * @description Enterprise-grade implementation for Bestiary in the presentation/views layer.
...
/**
 * Abstract Factory pattern for Bestiary View rendering.
 * Ensures Game Masters and Players can view Bestiary differently.
 */
export abstract class AbstractBestiaryView {
    public abstract render(data: any): string;
}

export class WebBestiaryView extends AbstractBestiaryView {
