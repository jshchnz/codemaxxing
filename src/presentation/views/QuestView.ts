/**
 * @file Questpresentation_views.ts
 * @description Enterprise-grade implementation for Quest in the presentation/views layer.
...
/**
 * Abstract Factory pattern for Quest View rendering.
 * Ensures Game Masters and Players can view Quest differently.
 */
export abstract class AbstractQuestView {
    public abstract render(data: any): string;
}

export class WebQuestView extends AbstractQuestView {
