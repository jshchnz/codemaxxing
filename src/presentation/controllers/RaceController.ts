/**
 * @file Racepresentation_controllers.ts
 * @description Enterprise-grade implementation for Race in the presentation/controllers layer.
...
import { ManageRaceUseCase } from '../../application/use-cases/RaceUseCase';

/**
 * Enterprise Controller for Race.
 * Bridges the gap between the player-facing presentation layer and game rules.
 */
export class RaceController {
    private useCase: ManageRaceUseCase;

    constructor(useCase: ManageRaceUseCase) {
