/**
 * @file DiceRollpresentation_controllers.ts
 * @description Enterprise-grade implementation for DiceRoll in the presentation/controllers layer.
...
import { ManageDiceRollUseCase } from '../../application/use-cases/DiceRollUseCase';

/**
 * Enterprise Controller for DiceRoll.
 * Bridges the gap between the player-facing presentation layer and game rules.
 */
export class DiceRollController {
    private useCase: ManageDiceRollUseCase;

    constructor(useCase: ManageDiceRollUseCase) {
