/**
 * @file Partypresentation_controllers.ts
 * @description Enterprise-grade implementation for Party in the presentation/controllers layer.
...
import { ManagePartyUseCase } from '../../application/use-cases/PartyUseCase';

/**
 * Enterprise Controller for Party.
 * Bridges the gap between the player-facing presentation layer and game rules.
 */
export class PartyController {
    private useCase: ManagePartyUseCase;

    constructor(useCase: ManagePartyUseCase) {
