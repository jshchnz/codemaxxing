/**
 * @file Sessionpresentation_controllers.ts
 * @description Enterprise-grade implementation for Session in the presentation/controllers layer.
...
import { ManageSessionUseCase } from '../../application/use-cases/SessionUseCase';

/**
 * Enterprise Controller for Session.
 * Bridges the gap between the player-facing presentation layer and game rules.
 */
export class SessionController {
    private useCase: ManageSessionUseCase;

    constructor(useCase: ManageSessionUseCase) {
