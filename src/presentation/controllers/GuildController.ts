/**
 * @file Guildpresentation_controllers.ts
 * @description Enterprise-grade implementation for Guild in the presentation/controllers layer.
...
import { ManageGuildUseCase } from '../../application/use-cases/GuildUseCase';

/**
 * Enterprise Controller for Guild.
 * Bridges the gap between the player-facing presentation layer and game rules.
 */
export class GuildController {
    private useCase: ManageGuildUseCase;

    constructor(useCase: ManageGuildUseCase) {
