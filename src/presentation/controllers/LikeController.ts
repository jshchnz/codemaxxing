/**
 * @file Likepresentation_controllers.ts
 * @description Enterprise-grade implementation for Like in the presentation/controllers layer.
...
import { ManageLikeUseCase } from '../../application/use-cases/LikeUseCase';

/**
 * Enterprise Controller for Like.
 * Bridges the gap between the presentation layer and application use cases.
 */
export class LikeController {
    private useCase: ManageLikeUseCase;

    constructor(useCase: ManageLikeUseCase) {
