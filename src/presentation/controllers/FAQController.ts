/**
 * @file FAQpresentation_controllers.ts
 * @description Enterprise-grade implementation for FAQ in the presentation/controllers layer.
...
import { ManageFAQUseCase } from '../../application/use-cases/FAQUseCase';

/**
 * Enterprise Controller for FAQ.
 * Bridges the gap between the presentation layer and application use cases.
 */
export class FAQController {
    private useCase: ManageFAQUseCase;

    constructor(useCase: ManageFAQUseCase) {
