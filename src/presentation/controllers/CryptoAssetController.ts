 ...
 * ============================================================================
 *
 * File: CryptoAssetController.ts
 * Description: Controller for CryptoAsset
 *
...
export class CryptoAssetController {
    ...
    /**
     * Handles a request to process CryptoAsset
     */
    public handleRequest(request: any): any {
        console.log("Handling request for CryptoAsset");
