/**
 * @file Bestiarypresentation_controllers.ts
 * @description Enterprise-grade implementation for Bestiary in the presentation/controllers layer.
...
import { ManageBestiaryUseCase } from '../../application/use-cases/BestiaryUseCase';

/**
 * Enterprise Controller for Bestiary.
 * Bridges the gap between the player-facing presentation layer and game rules.
 */
export class BestiaryController {
    private useCase: ManageBestiaryUseCase;

    constructor(useCase: ManageBestiaryUseCase) {
