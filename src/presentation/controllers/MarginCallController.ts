 ...
 * ============================================================================
 *
 * File: MarginCallController.ts
 * Description: Controller for MarginCall
 *
...
export class MarginCallController {
    ...
    /**
     * Handles a request to process MarginCall
     */
    public handleRequest(request: any): any {
        console.log("Handling request for MarginCall");
