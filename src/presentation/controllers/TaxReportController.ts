 ...
 * ============================================================================
 *
 * File: TaxReportController.ts
 * Description: Controller for TaxReport
 *
...
export class TaxReportController {
    ...
    /**
     * Handles a request to process TaxReport
     */
    public handleRequest(request: any): any {
        console.log("Handling request for TaxReport");
