 ...
 * ============================================================================
 *
 * File: ExchangeRateController.ts
 * Description: Controller for ExchangeRate
 *
...
export class ExchangeRateController {
    ...
    /**
     * Handles a request to process ExchangeRate
     */
    public handleRequest(request: any): any {
        console.log("Handling request for ExchangeRate");
