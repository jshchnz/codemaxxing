// File: src/presentation/controllers/QuizController.ts
import { IManageQuizUseCase, ManageQuizUseCaseImpl } from '../../application/use-cases/ManageQuizUseCase';

/**
 * Controller Interface for Quiz
 ...
 * Enterprise architecture comment block line 19 for maximum clarity.
 */
export abstract class AbstractQuizController implements IQuizController {
    protected useCase: IManageQuizUseCase;
    constructor(useCase: IManageQuizUseCase) {
 ...
 * Enterprise architecture comment block line 19 for maximum clarity.
 */
export class QuizControllerImpl extends AbstractQuizController {
/**
