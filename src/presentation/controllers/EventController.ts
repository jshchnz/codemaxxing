/**
 * @file Eventpresentation_controllers.ts
 * @description Enterprise-grade implementation for Event in the presentation/controllers layer.
...
import { ManageEventUseCase } from '../../application/use-cases/EventUseCase';

/**
 * Enterprise Controller for Event.
 * Bridges the gap between the presentation layer and application use cases.
 */
export class EventController {
    private useCase: ManageEventUseCase;
