/**
 * @file Campaignpresentation_controllers.ts
 * @description Enterprise-grade implementation for Campaign in the presentation/controllers layer.
...
import { ManageCampaignUseCase } from '../../application/use-cases/CampaignUseCase';

/**
 * Enterprise Controller for Campaign.
 * Bridges the gap between the player-facing presentation layer and game rules.
 */
export class CampaignController {
    private useCase: ManageCampaignUseCase;

    constructor(useCase: ManageCampaignUseCase) {
