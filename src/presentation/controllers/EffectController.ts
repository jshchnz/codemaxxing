/**
 * @file Effectpresentation_controllers.ts
 * @description Enterprise-grade implementation for Effect in the presentation/controllers layer.
...
import { ManageEffectUseCase } from '../../application/use-cases/EffectUseCase';

/**
 * Enterprise Controller for Effect.
 * Bridges the gap between the player-facing presentation layer and game rules.
 */
export class EffectController {
    private useCase: ManageEffectUseCase;

    constructor(useCase: ManageEffectUseCase) {
