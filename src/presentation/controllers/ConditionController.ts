/**
 * @file Conditionpresentation_controllers.ts
 * @description Enterprise-grade implementation for Condition in the presentation/controllers layer.
...
import { ManageConditionUseCase } from '../../application/use-cases/ConditionUseCase';

/**
 * Enterprise Controller for Condition.
 * Bridges the gap between the player-facing presentation layer and game rules.
 */
export class ConditionController {
    private useCase: ManageConditionUseCase;

    constructor(useCase: ManageConditionUseCase) {
