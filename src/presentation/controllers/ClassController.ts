/**
 * @file Classpresentation_controllers.ts
 * @description Enterprise-grade implementation for Class in the presentation/controllers layer.
...
import { ManageClassUseCase } from '../../application/use-cases/ClassUseCase';

/**
 * Enterprise Controller for Class.
 * Bridges the gap between the player-facing presentation layer and game rules.
 */
export class ClassController {
    private useCase: ManageClassUseCase;

    constructor(useCase: ManageClassUseCase) {
