/**
 * @file Artistpresentation_controllers.ts
 * @description Enterprise-grade implementation for Artist in the presentation/controllers layer.
...
import { ManageArtistUseCase } from '../../application/use-cases/ArtistUseCase';

/**
 * Enterprise Controller for Artist.
 * Bridges the gap between the presentation layer and application use cases.
 */
export class ArtistController {
    private useCase: ManageArtistUseCase;

    constructor(useCase: ManageArtistUseCase) {
