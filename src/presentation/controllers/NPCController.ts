/**
 * @file NPCpresentation_controllers.ts
 * @description Enterprise-grade implementation for NPC in the presentation/controllers layer.
...
import { ManageNPCUseCase } from '../../application/use-cases/NPCUseCase';

/**
 * Enterprise Controller for NPC.
 * Bridges the gap between the player-facing presentation layer and game rules.
 */
export class NPCController {
    private useCase: ManageNPCUseCase;

    constructor(useCase: ManageNPCUseCase) {
