/**
 * @file CarbonOffsetpresentation_models.ts
 * @description Enterprise-grade implementation for CarbonOffset in the presentation/models layer.
...
/**
 * View Model for CarbonOffset.
 * Prepares data specifically for the presentation layer.
 */
export class CarbonOffsetViewModel {
