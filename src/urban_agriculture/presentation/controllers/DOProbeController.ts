/**
 * @file DOProbepresentation_controllers.ts
 * @description Enterprise-grade implementation for DOProbe in the presentation/controllers layer.
...
import { ManageDOProbeUseCase } from '../../application/use-cases/DOProbeUseCase';

/**
 * Enterprise Controller for DOProbe.
 * Bridges the gap between the presentation layer and application use cases.
 */
export class DOProbeController {
    private useCase: ManageDOProbeUseCase;

    constructor(useCase: ManageDOProbeUseCase) {
