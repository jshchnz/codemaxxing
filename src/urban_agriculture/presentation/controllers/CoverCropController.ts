/**
 * @file CoverCroppresentation_controllers.ts
 * @description Enterprise-grade implementation for CoverCrop in the presentation/controllers layer.
...
import { ManageCoverCropUseCase } from '../../application/use-cases/CoverCropUseCase';

/**
 * Enterprise Controller for CoverCrop.
 * Bridges the gap between the presentation layer and application use cases.
 */
export class CoverCropController {
    private useCase: ManageCoverCropUseCase;

    constructor(useCase: ManageCoverCropUseCase) {
