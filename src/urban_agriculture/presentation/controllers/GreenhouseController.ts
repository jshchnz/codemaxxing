/**
 * @file Greenhousepresentation_controllers.ts
 * @description Enterprise-grade implementation for Greenhouse in the presentation/controllers layer.
...
import { ManageGreenhouseUseCase } from '../../application/use-cases/GreenhouseUseCase';

/**
 * Enterprise Controller for Greenhouse.
 * Bridges the gap between the presentation layer and application use cases.
 */
export class GreenhouseController {
    private useCase: ManageGreenhouseUseCase;

    constructor(useCase: ManageGreenhouseUseCase) {
