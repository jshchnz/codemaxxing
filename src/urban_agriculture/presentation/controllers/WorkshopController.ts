/**
 * @file Workshoppresentation_controllers.ts
 * @description Enterprise-grade implementation for Workshop in the presentation/controllers layer.
...
import { ManageWorkshopUseCase } from '../../application/use-cases/WorkshopUseCase';

/**
 * Enterprise Controller for Workshop.
 * Bridges the gap between the presentation layer and application use cases.
 */
export class WorkshopController {
    private useCase: ManageWorkshopUseCase;

    constructor(useCase: ManageWorkshopUseCase) {
