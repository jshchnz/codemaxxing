/**
 * @file TemperatureSensorpresentation_controllers.ts
 * @description Enterprise-grade implementation for TemperatureSensor in the presentation/controllers layer.
...
import { ManageTemperatureSensorUseCase } from '../../application/use-cases/TemperatureSensorUseCase';

/**
 * Enterprise Controller for TemperatureSensor.
 * Bridges the gap between the presentation layer and application use cases.
 */
export class TemperatureSensorController {
    private useCase: ManageTemperatureSensorUseCase;

    constructor(useCase: ManageTemperatureSensorUseCase) {
