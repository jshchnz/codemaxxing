/**
 * @file Coursepresentation_controllers.ts
 * @description Enterprise-grade implementation for Course in the presentation/controllers layer.
...
import { ManageCourseUseCase } from '../../application/use-cases/CourseUseCase';

/**
 * Enterprise Controller for Course.
 * Bridges the gap between the presentation layer and application use cases.
 */
export class CourseController {
    private useCase: ManageCourseUseCase;

    constructor(useCase: ManageCourseUseCase) {
