/**
 * @file BeneficialInsectpresentation_controllers.ts
 * @description Enterprise-grade implementation for BeneficialInsect in the presentation/controllers layer.
...
import { ManageBeneficialInsectUseCase } from '../../application/use-cases/BeneficialInsectUseCase';

/**
 * Enterprise Controller for BeneficialInsect.
 * Bridges the gap between the presentation layer and application use cases.
 */
export class BeneficialInsectController {
    private useCase: ManageBeneficialInsectUseCase;

    constructor(useCase: ManageBeneficialInsectUseCase) {
