/**
 * @file PlantingSchedulepresentation_controllers.ts
 * @description Enterprise-grade implementation for PlantingSchedule in the presentation/controllers layer.
...
import { ManagePlantingScheduleUseCase } from '../../application/use-cases/PlantingScheduleUseCase';

/**
 * Enterprise Controller for PlantingSchedule.
 * Bridges the gap between the presentation layer and application use cases.
 */
export class PlantingScheduleController {
    private useCase: ManagePlantingScheduleUseCase;

    constructor(useCase: ManagePlantingScheduleUseCase) {
