/**
 * @file PumpSchedulepresentation_controllers.ts
 * @description Enterprise-grade implementation for PumpSchedule in the presentation/controllers layer.
...
import { ManagePumpScheduleUseCase } from '../../application/use-cases/PumpScheduleUseCase';

/**
 * Enterprise Controller for PumpSchedule.
 * Bridges the gap between the presentation layer and application use cases.
 */
export class PumpScheduleController {
    private useCase: ManagePumpScheduleUseCase;

    constructor(useCase: ManagePumpScheduleUseCase) {
