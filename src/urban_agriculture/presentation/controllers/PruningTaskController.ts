/**
 * @file PruningTaskpresentation_controllers.ts
 * @description Enterprise-grade implementation for PruningTask in the presentation/controllers layer.
...
import { ManagePruningTaskUseCase } from '../../application/use-cases/PruningTaskUseCase';

/**
 * Enterprise Controller for PruningTask.
 * Bridges the gap between the presentation layer and application use cases.
 */
export class PruningTaskController {
    private useCase: ManagePruningTaskUseCase;

    constructor(useCase: ManagePruningTaskUseCase) {
