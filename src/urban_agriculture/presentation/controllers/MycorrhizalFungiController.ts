/**
 * @file MycorrhizalFungipresentation_controllers.ts
 * @description Enterprise-grade implementation for MycorrhizalFungi in the presentation/controllers layer.
...
import { ManageMycorrhizalFungiUseCase } from '../../application/use-cases/MycorrhizalFungiUseCase';

/**
 * Enterprise Controller for MycorrhizalFungi.
 * Bridges the gap between the presentation layer and application use cases.
 */
export class MycorrhizalFungiController {
    private useCase: ManageMycorrhizalFungiUseCase;

    constructor(useCase: ManageMycorrhizalFungiUseCase) {
