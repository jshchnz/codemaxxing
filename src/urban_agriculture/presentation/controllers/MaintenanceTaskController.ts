/**
 * @file MaintenanceTaskpresentation_controllers.ts
 * @description Enterprise-grade implementation for MaintenanceTask in the presentation/controllers layer.
...
import { ManageMaintenanceTaskUseCase } from '../../application/use-cases/MaintenanceTaskUseCase';

/**
 * Enterprise Controller for MaintenanceTask.
 * Bridges the gap between the presentation layer and application use cases.
 */
export class MaintenanceTaskController {
    private useCase: ManageMaintenanceTaskUseCase;

    constructor(useCase: ManageMaintenanceTaskUseCase) {
