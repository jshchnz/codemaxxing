/**
 * @file PestObservationpresentation_controllers.ts
 * @description Enterprise-grade implementation for PestObservation in the presentation/controllers layer.
...
import { ManagePestObservationUseCase } from '../../application/use-cases/PestObservationUseCase';

/**
 * Enterprise Controller for PestObservation.
 * Bridges the gap between the presentation layer and application use cases.
 */
export class PestObservationController {
    private useCase: ManagePestObservationUseCase;

    constructor(useCase: ManagePestObservationUseCase) {
