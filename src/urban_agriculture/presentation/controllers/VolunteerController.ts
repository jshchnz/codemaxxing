/**
 * @file Volunteerpresentation_controllers.ts
 * @description Enterprise-grade implementation for Volunteer in the presentation/controllers layer.
...
import { ManageVolunteerUseCase } from '../../application/use-cases/VolunteerUseCase';

/**
 * Enterprise Controller for Volunteer.
 * Bridges the gap between the presentation layer and application use cases.
 */
export class VolunteerController {
    private useCase: ManageVolunteerUseCase;

    constructor(useCase: ManageVolunteerUseCase) {
