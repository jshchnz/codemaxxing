/**
 * @file HarvestLogpresentation_controllers.ts
 * @description Enterprise-grade implementation for HarvestLog in the presentation/controllers layer.
...
import { ManageHarvestLogUseCase } from '../../application/use-cases/HarvestLogUseCase';

/**
 * Enterprise Controller for HarvestLog.
 * Bridges the gap between the presentation layer and application use cases.
 */
export class HarvestLogController {
    private useCase: ManageHarvestLogUseCase;

    constructor(useCase: ManageHarvestLogUseCase) {
