/**
 * @file Chillerpresentation_controllers.ts
 * @description Enterprise-grade implementation for Chiller in the presentation/controllers layer.
...
import { ManageChillerUseCase } from '../../application/use-cases/ChillerUseCase';

/**
 * Enterprise Controller for Chiller.
 * Bridges the gap between the presentation layer and application use cases.
 */
export class ChillerController {
    private useCase: ManageChillerUseCase;

    constructor(useCase: ManageChillerUseCase) {
