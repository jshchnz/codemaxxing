/**
 * @file Legumepresentation_controllers.ts
 * @description Enterprise-grade implementation for Legume in the presentation/controllers layer.
...
import { ManageLegumeUseCase } from '../../application/use-cases/LegumeUseCase';

/**
 * Enterprise Controller for Legume.
 * Bridges the gap between the presentation layer and application use cases.
 */
export class LegumeController {
    private useCase: ManageLegumeUseCase;

    constructor(useCase: ManageLegumeUseCase) {
