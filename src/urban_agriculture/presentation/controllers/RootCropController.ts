/**
 * @file RootCroppresentation_controllers.ts
 * @description Enterprise-grade implementation for RootCrop in the presentation/controllers layer.
...
import { ManageRootCropUseCase } from '../../application/use-cases/RootCropUseCase';

/**
 * Enterprise Controller for RootCrop.
 * Bridges the gap between the presentation layer and application use cases.
 */
export class RootCropController {
    private useCase: ManageRootCropUseCase;

    constructor(useCase: ManageRootCropUseCase) {
