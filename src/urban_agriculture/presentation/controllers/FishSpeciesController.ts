/**
 * @file FishSpeciespresentation_controllers.ts
 * @description Enterprise-grade implementation for FishSpecies in the presentation/controllers layer.
...
import { ManageFishSpeciesUseCase } from '../../application/use-cases/FishSpeciesUseCase';

/**
 * Enterprise Controller for FishSpecies.
 * Bridges the gap between the presentation layer and application use cases.
 */
export class FishSpeciesController {
    private useCase: ManageFishSpeciesUseCase;

    constructor(useCase: ManageFishSpeciesUseCase) {
