/**
 * @file Invoicepresentation_controllers.ts
 * @description Enterprise-grade implementation for Invoice in the presentation/controllers layer.
...
import { ManageInvoiceUseCase } from '../../application/use-cases/InvoiceUseCase';

/**
 * Enterprise Controller for Invoice.
 * Bridges the gap between the presentation layer and application use cases.
 */
export class InvoiceController {
    private useCase: ManageInvoiceUseCase;

    constructor(useCase: ManageInvoiceUseCase) {
