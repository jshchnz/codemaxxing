/**
 * @file Grantpresentation_controllers.ts
 * @description Enterprise-grade implementation for Grant in the presentation/controllers layer.
...
import { ManageGrantUseCase } from '../../application/use-cases/GrantUseCase';

/**
 * Enterprise Controller for Grant.
 * Bridges the gap between the presentation layer and application use cases.
 */
export class GrantController {
    private useCase: ManageGrantUseCase;

    constructor(useCase: ManageGrantUseCase) {
