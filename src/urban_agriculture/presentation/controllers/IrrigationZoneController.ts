/**
 * @file IrrigationZonepresentation_controllers.ts
 * @description Enterprise-grade implementation for IrrigationZone in the presentation/controllers layer.
...
import { ManageIrrigationZoneUseCase } from '../../application/use-cases/IrrigationZoneUseCase';

/**
 * Enterprise Controller for IrrigationZone.
 * Bridges the gap between the presentation layer and application use cases.
 */
export class IrrigationZoneController {
    private useCase: ManageIrrigationZoneUseCase;

    constructor(useCase: ManageIrrigationZoneUseCase) {
