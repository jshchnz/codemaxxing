/**
 * @file FishSpeciespresentation_models.ts
 * @description Enterprise-grade implementation for FishSpecies in the presentation/models layer.
...
/**
 * View Model for FishSpecies.
 * Prepares data specifically for the presentation layer.
 */
export class FishSpeciesViewModel {
