/**
 * @file IrrigationZonepresentation_models.ts
 * @description Enterprise-grade implementation for IrrigationZone in the presentation/models layer.
...
/**
 * View Model for IrrigationZone.
 * Prepares data specifically for the presentation layer.
 */
export class IrrigationZoneViewModel {
