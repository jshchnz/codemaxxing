/**
 * @file YieldTrackerdomain_repositories.ts
 * @description Enterprise-grade implementation for YieldTracker in the domain/repositories layer.
...
import { IYieldTracker } from '../models/YieldTracker';

/**
 * Repository interface for YieldTracker.
 * Follows the Repository pattern to abstract data access.
 */
export interface IYieldTrackerRepository {
    findById(id: string): Promise<IYieldTracker | null>;
    findAll(): Promise<IYieldTracker[]>;
    save(entity: IYieldTracker): Promise<void>;
