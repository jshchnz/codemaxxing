/**
 * @file PolycultureBeddomain_repositories.ts
 * @description Enterprise-grade implementation for PolycultureBed in the domain/repositories layer.
...
import { IPolycultureBed } from '../models/PolycultureBed';

/**
 * Repository interface for PolycultureBed.
 * Follows the Repository pattern to abstract data access.
 */
export interface IPolycultureBedRepository {
    findById(id: string): Promise<IPolycultureBed | null>;
    findAll(): Promise<IPolycultureBed[]>;
    save(entity: IPolycultureBed): Promise<void>;
