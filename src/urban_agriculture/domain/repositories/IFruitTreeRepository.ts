/**
 * @file FruitTreedomain_repositories.ts
 * @description Enterprise-grade implementation for FruitTree in the domain/repositories layer.
...
import { IFruitTree } from '../models/FruitTree';

/**
 * Repository interface for FruitTree.
 * Follows the Repository pattern to abstract data access.
 */
export interface IFruitTreeRepository {
    findById(id: string): Promise<IFruitTree | null>;
    findAll(): Promise<IFruitTree[]>;
    save(entity: IFruitTree): Promise<void>;
