/**
 * @file Volunteerdomain_repositories.ts
 * @description Enterprise-grade implementation for Volunteer in the domain/repositories layer.
...
/**
 * Repository interface for Volunteer.
 * Follows the Repository pattern to abstract data access.
 */
export interface IVolunteerRepository {
    findById(id: string): Promise<IVolunteer | null>;
    findAll(): Promise<IVolunteer[]>;
    save(entity: IVolunteer): Promise<void>;
