/**
 * @file Greenhousedomain_repositories.ts
 * @description Enterprise-grade implementation for Greenhouse in the domain/repositories layer.
...
import { IGreenhouse } from '../models/Greenhouse';

/**
 * Repository interface for Greenhouse.
 * Follows the Repository pattern to abstract data access.
 */
export interface IGreenhouseRepository {
    findById(id: string): Promise<IGreenhouse | null>;
    findAll(): Promise<IGreenhouse[]>;
    save(entity: IGreenhouse): Promise<void>;
