/**
 * @file PumpScheduledomain_repositories.ts
 * @description Enterprise-grade implementation for PumpSchedule in the domain/repositories layer.
...
import { IPumpSchedule } from '../models/PumpSchedule';

/**
 * Repository interface for PumpSchedule.
 * Follows the Repository pattern to abstract data access.
 */
export interface IPumpScheduleRepository {
    findById(id: string): Promise<IPumpSchedule | null>;
    findAll(): Promise<IPumpSchedule[]>;
    save(entity: IPumpSchedule): Promise<void>;
