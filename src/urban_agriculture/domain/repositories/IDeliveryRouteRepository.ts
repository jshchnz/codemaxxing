/**
 * @file DeliveryRoutedomain_repositories.ts
 * @description Enterprise-grade implementation for DeliveryRoute in the domain/repositories layer.
...
import { IDeliveryRoute } from '../models/DeliveryRoute';

/**
 * Repository interface for DeliveryRoute.
 * Follows the Repository pattern to abstract data access.
 */
export interface IDeliveryRouteRepository {
    findById(id: string): Promise<IDeliveryRoute | null>;
    findAll(): Promise<IDeliveryRoute[]>;
    save(entity: IDeliveryRoute): Promise<void>;
