/**
 * @file Swaledomain_repositories.ts
 * @description Enterprise-grade implementation for Swale in the domain/repositories layer.
...
import { ISwale } from '../models/Swale';

/**
 * Repository interface for Swale.
 * Follows the Repository pattern to abstract data access.
 */
export interface ISwaleRepository {
    findById(id: string): Promise<ISwale | null>;
    findAll(): Promise<ISwale[]>;
    save(entity: ISwale): Promise<void>;
