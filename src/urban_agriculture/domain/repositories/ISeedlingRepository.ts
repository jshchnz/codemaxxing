/**
 * @file Seedlingdomain_repositories.ts
 * @description Enterprise-grade implementation for Seedling in the domain/repositories layer.
...
import { ISeedling } from '../models/Seedling';

/**
 * Repository interface for Seedling.
 * Follows the Repository pattern to abstract data access.
 */
export interface ISeedlingRepository {
    findById(id: string): Promise<ISeedling | null>;
    findAll(): Promise<ISeedling[]>;
    save(entity: ISeedling): Promise<void>;
