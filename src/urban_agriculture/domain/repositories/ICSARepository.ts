/**
 * @file CSAdomain_repositories.ts
 * @description Enterprise-grade implementation for CSA in the domain/repositories layer.
...
import { ICSA } from '../models/CSA';

/**
 * Repository interface for CSA.
 * Follows the Repository pattern to abstract data access.
 */
export interface ICSARepository {
    findById(id: string): Promise<ICSA | null>;
    findAll(): Promise<ICSA[]>;
    save(entity: ICSA): Promise<void>;
