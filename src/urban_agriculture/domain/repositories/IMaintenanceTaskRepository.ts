/**
 * @file MaintenanceTaskdomain_repositories.ts
 * @description Enterprise-grade implementation for MaintenanceTask in the domain/repositories layer.
...
import { IMaintenanceTask } from '../models/MaintenanceTask';

/**
 * Repository interface for MaintenanceTask.
 * Follows the Repository pattern to abstract data access.
 */
export interface IMaintenanceTaskRepository {
    findById(id: string): Promise<IMaintenanceTask | null>;
    findAll(): Promise<IMaintenanceTask[]>;
    save(entity: IMaintenanceTask): Promise<void>;
