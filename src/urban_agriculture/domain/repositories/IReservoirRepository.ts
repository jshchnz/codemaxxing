/**
 * @file Reservoirdomain_repositories.ts
 * @description Enterprise-grade implementation for Reservoir in the domain/repositories layer.
...
/**
 * Repository interface for Reservoir.
 * Follows the Repository pattern to abstract data access.
 */
export interface IReservoirRepository {
    findById(id: string): Promise<IReservoir | null>;
    findAll(): Promise<IReservoir[]>;
    save(entity: IReservoir): Promise<void>;
