/**
 * @file AirStonedomain_repositories.ts
 * @description Enterprise-grade implementation for AirStone in the domain/repositories layer.
...
import { IAirStone } from '../models/AirStone';

/**
 * Repository interface for AirStone.
 * Follows the Repository pattern to abstract data access.
 */
export interface IAirStoneRepository {
    findById(id: string): Promise<IAirStone | null>;
    findAll(): Promise<IAirStone[]>;
    save(entity: IAirStone): Promise<void>;
