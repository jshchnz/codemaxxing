/**
 * @file Brassicadomain_repositories.ts
 * @description Enterprise-grade implementation for Brassica in the domain/repositories layer.
...
import { IBrassica } from '../models/Brassica';

/**
 * Repository interface for Brassica.
 * Follows the Repository pattern to abstract data access.
 */
export interface IBrassicaRepository {
    findById(id: string): Promise<IBrassica | null>;
    findAll(): Promise<IBrassica[]>;
    save(entity: IBrassica): Promise<void>;
