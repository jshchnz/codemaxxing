/**
 * @file PestObservationdomain_repositories.ts
 * @description Enterprise-grade implementation for PestObservation in the domain/repositories layer.
...
import { IPestObservation } from '../models/PestObservation';

/**
 * Repository interface for PestObservation.
 * Follows the Repository pattern to abstract data access.
 */
export interface IPestObservationRepository {
    findById(id: string): Promise<IPestObservation | null>;
    findAll(): Promise<IPestObservation[]>;
    save(entity: IPestObservation): Promise<void>;
