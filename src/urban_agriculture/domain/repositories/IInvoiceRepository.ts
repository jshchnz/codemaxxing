/**
 * @file Invoicedomain_repositories.ts
 * @description Enterprise-grade implementation for Invoice in the domain/repositories layer.
...
export interface IInvoiceRepository {
    ...
    save(entity: IInvoice): Promise<void>;
