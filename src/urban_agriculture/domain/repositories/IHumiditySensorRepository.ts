/**
 * @file HumiditySensordomain_repositories.ts
 * @description Enterprise-grade implementation for HumiditySensor in the domain/repositories layer.
...
import { IHumiditySensor } from '../models/HumiditySensor';

/**
 * Repository interface for HumiditySensor.
 * Follows the Repository pattern to abstract data access.
 */
export interface IHumiditySensorRepository {
    findById(id: string): Promise<IHumiditySensor | null>;
    findAll(): Promise<IHumiditySensor[]>;
    save(entity: IHumiditySensor): Promise<void>;
