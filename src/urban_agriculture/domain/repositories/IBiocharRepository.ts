/**
 * @file Biochardomain_repositories.ts
 * @description Enterprise-grade implementation for Biochar in the domain/repositories layer.
...
import { IBiochar } from '../models/Biochar';

/**
 * Repository interface for Biochar.
 * Follows the Repository pattern to abstract data access.
 */
export interface IBiocharRepository {
    findById(id: string): Promise<IBiochar | null>;
    findAll(): Promise<IBiochar[]>;
    save(entity: IBiochar): Promise<void>;
