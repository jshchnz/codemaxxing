/**
 * @file IrrigationZonedomain_repositories.ts
 * @description Enterprise-grade implementation for IrrigationZone in the domain/repositories layer.
...
import { IIrrigationZone } from '../models/IrrigationZone';

/**
 * Repository interface for IrrigationZone.
 * Follows the Repository pattern to abstract data access.
 */
export interface IIrrigationZoneRepository {
    findById(id: string): Promise<IIrrigationZone | null>;
    findAll(): Promise<IIrrigationZone[]>;
    save(entity: IIrrigationZone): Promise<void>;
