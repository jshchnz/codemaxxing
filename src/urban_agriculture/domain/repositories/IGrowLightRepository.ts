/**
 * @file GrowLightdomain_repositories.ts
 * @description Enterprise-grade implementation for GrowLight in the domain/repositories layer.
...
import { IGrowLight } from '../models/GrowLight';

/**
 * Repository interface for GrowLight.
 * Follows the Repository pattern to abstract data access.
 */
export interface IGrowLightRepository {
    findById(id: string): Promise<IGrowLight | null>;
    findAll(): Promise<IGrowLight[]>;
    save(entity: IGrowLight): Promise<void>;
