/**
 * @file KeyholeGardendomain_repositories.ts
 * @description Enterprise-grade implementation for KeyholeGarden in the domain/repositories layer.
...
import { IKeyholeGarden } from '../models/KeyholeGarden';

/**
 * Repository interface for KeyholeGarden.
 * Follows the Repository pattern to abstract data access.
 */
export interface IKeyholeGardenRepository {
    findById(id: string): Promise<IKeyholeGarden | null>;
    findAll(): Promise<IKeyholeGarden[]>;
    save(entity: IKeyholeGarden): Promise<void>;
