/**
 * @file ECMeterdomain_repositories.ts
 * @description Enterprise-grade implementation for ECMeter in the domain/repositories layer.
...
import { IECMeter } from '../models/ECMeter';

/**
 * Repository interface for ECMeter.
 * Follows the Repository pattern to abstract data access.
 */
export interface IECMeterRepository {
    findById(id: string): Promise<IECMeter | null>;
    findAll(): Promise<IECMeter[]>;
    save(entity: IECMeter): Promise<void>;
