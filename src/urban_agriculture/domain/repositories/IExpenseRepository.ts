/**
 * @file Expensedomain_repositories.ts
 * @description Enterprise-grade implementation for Expense in the domain/repositories layer.
...
export interface IExpenseRepository {
    ...
    save(entity: IExpense): Promise<void>;
