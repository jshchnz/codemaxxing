/**
 * @file WaterQualityLogdomain_repositories.ts
 * @description Enterprise-grade implementation for WaterQualityLog in the domain/repositories layer.
...
import { IWaterQualityLog } from '../models/WaterQualityLog';

/**
 * Repository interface for WaterQualityLog.
 * Follows the Repository pattern to abstract data access.
 */
export interface IWaterQualityLogRepository {
    findById(id: string): Promise<IWaterQualityLog | null>;
    findAll(): Promise<IWaterQualityLog[]>;
    save(entity: IWaterQualityLog): Promise<void>;
