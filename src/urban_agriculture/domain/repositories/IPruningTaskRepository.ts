/**
 * @file PruningTaskdomain_repositories.ts
 * @description Enterprise-grade implementation for PruningTask in the domain/repositories layer.
...
import { IPruningTask } from '../models/PruningTask';

/**
 * Repository interface for PruningTask.
 * Follows the Repository pattern to abstract data access.
 */
export interface IPruningTaskRepository {
    findById(id: string): Promise<IPruningTask | null>;
    findAll(): Promise<IPruningTask[]>;
    save(entity: IPruningTask): Promise<void>;
