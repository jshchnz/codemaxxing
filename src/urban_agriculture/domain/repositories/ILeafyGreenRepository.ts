/**
 * @file LeafyGreendomain_repositories.ts
 * @description Enterprise-grade implementation for LeafyGreen in the domain/repositories layer.
...
import { ILeafyGreen } from '../models/LeafyGreen';

/**
 * Repository interface for LeafyGreen.
 * Follows the Repository pattern to abstract data access.
 */
export interface ILeafyGreenRepository {
    findById(id: string): Promise<ILeafyGreen | null>;
    findAll(): Promise<ILeafyGreen[]>;
    save(entity: ILeafyGreen): Promise<void>;
