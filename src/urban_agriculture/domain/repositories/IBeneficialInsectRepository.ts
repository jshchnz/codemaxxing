/**
 * @file BeneficialInsectdomain_repositories.ts
 * @description Enterprise-grade implementation for BeneficialInsect in the domain/repositories layer.
...
import { IBeneficialInsect } from '../models/BeneficialInsect';

/**
 * Repository interface for BeneficialInsect.
 * Follows the Repository pattern to abstract data access.
 */
export interface IBeneficialInsectRepository {
    findById(id: string): Promise<IBeneficialInsect | null>;
    findAll(): Promise<IBeneficialInsect[]>;
    save(entity: IBeneficialInsect): Promise<void>;
