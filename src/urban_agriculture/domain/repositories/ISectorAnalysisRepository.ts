/**
 * @file SectorAnalysisdomain_repositories.ts
 * @description Enterprise-grade implementation for SectorAnalysis in the domain/repositories layer.
...
import { ISectorAnalysis } from '../models/SectorAnalysis';

/**
 * Repository interface for SectorAnalysis.
 * Follows the Repository pattern to abstract data access.
 */
export interface ISectorAnalysisRepository {
    findById(id: string): Promise<ISectorAnalysis | null>;
    findAll(): Promise<ISectorAnalysis[]>;
    save(entity: ISectorAnalysis): Promise<void>;
