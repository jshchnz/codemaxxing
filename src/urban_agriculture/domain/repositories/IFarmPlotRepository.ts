/**
 * @file FarmPlotdomain_repositories.ts
 * @description Enterprise-grade implementation for FarmPlot in the domain/repositories layer.
...
import { IFarmPlot } from '../models/FarmPlot';

/**
 * Repository interface for FarmPlot.
 * Follows the Repository pattern to abstract data access.
 */
export interface IFarmPlotRepository {
    findById(id: string): Promise<IFarmPlot | null>;
    findAll(): Promise<IFarmPlot[]>;
    save(entity: IFarmPlot): Promise<void>;
