/**
 * @file WormFarmdomain_repositories.ts
 * @description Enterprise-grade implementation for WormFarm in the domain/repositories layer.
...
import { IWormFarm } from '../models/WormFarm';

/**
 * Repository interface for WormFarm.
 * Follows the Repository pattern to abstract data access.
 */
export interface IWormFarmRepository {
    findById(id: string): Promise<IWormFarm | null>;
    findAll(): Promise<IWormFarm[]>;
    save(entity: IWormFarm): Promise<void>;
