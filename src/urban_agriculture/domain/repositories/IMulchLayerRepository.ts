/**
 * @file MulchLayerdomain_repositories.ts
 * @description Enterprise-grade implementation for MulchLayer in the domain/repositories layer.
...
import { IMulchLayer } from '../models/MulchLayer';

/**
 * Repository interface for MulchLayer.
 * Follows the Repository pattern to abstract data access.
 */
export interface IMulchLayerRepository {
    findById(id: string): Promise<IMulchLayer | null>;
    findAll(): Promise<IMulchLayer[]>;
    save(entity: IMulchLayer): Promise<void>;
