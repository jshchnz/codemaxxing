/**
 * @file Chillerdomain_repositories.ts
 * @description Enterprise-grade implementation for Chiller in the domain/repositories layer.
...
import { IChiller } from '../models/Chiller';

/**
 * Repository interface for Chiller.
 * Follows the Repository pattern to abstract data access.
 */
export interface IChillerRepository {
    findById(id: string): Promise<IChiller | null>;
    findAll(): Promise<IChiller[]>;
    save(entity: IChiller): Promise<void>;
