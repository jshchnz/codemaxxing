/**
 * @file SeedBankdomain_repositories.ts
 * @description Enterprise-grade implementation for SeedBank in the domain/repositories layer.
...
import { ISeedBank } from '../models/SeedBank';

/**
 * Repository interface for SeedBank.
 * Follows the Repository pattern to abstract data access.
 */
export interface ISeedBankRepository {
    findById(id: string): Promise<ISeedBank | null>;
    findAll(): Promise<ISeedBank[]>;
    save(entity: ISeedBank): Promise<void>;
