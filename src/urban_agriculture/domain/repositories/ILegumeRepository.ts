/**
 * @file Legumedomain_repositories.ts
 * @description Enterprise-grade implementation for Legume in the domain/repositories layer.
...
import { ILegume } from '../models/Legume';

/**
 * Repository interface for Legume.
 * Follows the Repository pattern to abstract data access.
 */
export interface ILegumeRepository {
    findById(id: string): Promise<ILegume | null>;
    findAll(): Promise<ILegume[]>;
    save(entity: ILegume): Promise<void>;
