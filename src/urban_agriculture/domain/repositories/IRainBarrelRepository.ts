/**
 * @file RainBarreldomain_repositories.ts
 * @description Enterprise-grade implementation for RainBarrel in the domain/repositories layer.
...
import { IRainBarrel } from '../models/RainBarrel';

/**
 * Repository interface for RainBarrel.
 * Follows the Repository pattern to abstract data access.
 */
export interface IRainBarrelRepository {
    findById(id: string): Promise<IRainBarrel | null>;
    findAll(): Promise<IRainBarrel[]>;
    save(entity: IRainBarrel): Promise<void>;
