/**
 * @file NutrientSolutiondomain_repositories.ts
 * @description Enterprise-grade implementation for NutrientSolution in the domain/repositories layer.
...
import { INutrientSolution } from '../models/NutrientSolution';

/**
 * Repository interface for NutrientSolution.
 * Follows the Repository pattern to abstract data access.
 */
export interface INutrientSolutionRepository {
    findById(id: string): Promise<INutrientSolution | null>;
    findAll(): Promise<INutrientSolution[]>;
    save(entity: INutrientSolution): Promise<void>;
