/**
 * @file GrowMediumdomain_repositories.ts
 * @description Enterprise-grade implementation for GrowMedium in the domain/repositories layer.
...
import { IGrowMedium } from '../models/GrowMedium';

/**
 * Repository interface for GrowMedium.
 * Follows the Repository pattern to abstract data access.
 */
export interface IGrowMediumRepository {
    findById(id: string): Promise<IGrowMedium | null>;
    findAll(): Promise<IGrowMedium[]>;
    save(entity: IGrowMedium): Promise<void>;
