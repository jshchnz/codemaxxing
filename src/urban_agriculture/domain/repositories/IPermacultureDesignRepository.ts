/**
 * @file PermacultureDesigndomain_repositories.ts
 * @description Enterprise-grade implementation for PermacultureDesign in the domain/repositories layer.
...
import { IPermacultureDesign } from '../models/PermacultureDesign';

/**
 * Repository interface for PermacultureDesign.
 * Follows the Repository pattern to abstract data access.
 */
export interface IPermacultureDesignRepository {
    findById(id: string): Promise<IPermacultureDesign | null>;
    findAll(): Promise<IPermacultureDesign[]>;
    save(entity: IPermacultureDesign): Promise<void>;
