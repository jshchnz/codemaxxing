/**
 * @file FishSpeciesdomain_repositories.ts
 * @description Enterprise-grade implementation for FishSpecies in the domain/repositories layer.
...
import { IFishSpecies } from '../models/FishSpecies';

/**
 * Repository interface for FishSpecies.
 * Follows the Repository pattern to abstract data access.
 */
export interface IFishSpeciesRepository {
    findById(id: string): Promise<IFishSpecies | null>;
    findAll(): Promise<IFishSpecies[]>;
    save(entity: IFishSpecies): Promise<void>;
