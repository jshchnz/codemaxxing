/**
 * @file Biofilterdomain_repositories.ts
 * @description Enterprise-grade implementation for Biofilter in the domain/repositories layer.
...
import { IBiofilter } from '../models/Biofilter';

/**
 * Repository interface for Biofilter.
 * Follows the Repository pattern to abstract data access.
 */
export interface IBiofilterRepository {
    findById(id: string): Promise<IBiofilter | null>;
    findAll(): Promise<IBiofilter[]>;
    save(entity: IBiofilter): Promise<void>;
