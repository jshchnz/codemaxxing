/**
 * @file NetPotdomain_repositories.ts
 * @description Enterprise-grade implementation for NetPot in the domain/repositories layer.
...
import { INetPot } from '../models/NetPot';

/**
 * Repository interface for NetPot.
 * Follows the Repository pattern to abstract data access.
 */
export interface INetPotRepository {
    findById(id: string): Promise<INetPot | null>;
    findAll(): Promise<INetPot[]>;
    save(entity: INetPot): Promise<void>;
