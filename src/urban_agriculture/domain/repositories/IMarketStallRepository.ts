/**
 * @file MarketStalldomain_repositories.ts
 * @description Enterprise-grade implementation for MarketStall in the domain/repositories layer.
...
import { IMarketStall } from '../models/MarketStall';

/**
 * Repository interface for MarketStall.
 * Follows the Repository pattern to abstract data access.
 */
export interface IMarketStallRepository {
    findById(id: string): Promise<IMarketStall | null>;
    findAll(): Promise<IMarketStall[]>;
    save(entity: IMarketStall): Promise<void>;
