/**
 * @file WaterHeaterdomain_repositories.ts
 * @description Enterprise-grade implementation for WaterHeater in the domain/repositories layer.
...
import { IWaterHeater } from '../models/WaterHeater';

/**
 * Repository interface for WaterHeater.
 * Follows the Repository pattern to abstract data access.
 */
export interface IWaterHeaterRepository {
    findById(id: string): Promise<IWaterHeater | null>;
    findAll(): Promise<IWaterHeater[]>;
    save(entity: IWaterHeater): Promise<void>;
