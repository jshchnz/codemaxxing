/**
 * @file RooftopGardendomain_repositories.ts
 * @description Enterprise-grade implementation for RooftopGarden in the domain/repositories layer.
...
import { IRooftopGarden } from '../models/RooftopGarden';

/**
 * Repository interface for RooftopGarden.
 * Follows the Repository pattern to abstract data access.
 */
export interface IRooftopGardenRepository {
    findById(id: string): Promise<IRooftopGarden | null>;
    findAll(): Promise<IRooftopGarden[]>;
    save(entity: IRooftopGarden): Promise<void>;
