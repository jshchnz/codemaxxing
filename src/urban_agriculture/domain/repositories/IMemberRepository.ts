/**
 * @file Memberdomain_repositories.ts
 * @description Enterprise-grade implementation for Member in the domain/repositories layer.
...
export interface IMemberRepository {
    ...
    save(entity: IMember): Promise<void>;
