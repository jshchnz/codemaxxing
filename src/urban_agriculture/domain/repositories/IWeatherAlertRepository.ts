/**
 * @file WeatherAlertdomain_repositories.ts
 * @description Enterprise-grade implementation for WeatherAlert in the domain/repositories layer.
...
import { IWeatherAlert } from '../models/WeatherAlert';

/**
 * Repository interface for WeatherAlert.
 * Follows the Repository pattern to abstract data access.
 */
export interface IWeatherAlertRepository {
    findById(id: string): Promise<IWeatherAlert | null>;
    findAll(): Promise<IWeatherAlert[]>;
    save(entity: IWeatherAlert): Promise<void>;
