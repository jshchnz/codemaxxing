/**
 * @file Microclimatedomain_repositories.ts
 * @description Enterprise-grade implementation for Microclimate in the domain/repositories layer.
...
/**
 * Repository interface for Microclimate.
 * Follows the Repository pattern to abstract data access.
 */
export interface IMicroclimateRepository {
    findById(id: string): Promise<IMicroclimate | null>;
    findAll(): Promise<IMicroclimate[]>;
    save(entity: IMicroclimate): Promise<void>;
