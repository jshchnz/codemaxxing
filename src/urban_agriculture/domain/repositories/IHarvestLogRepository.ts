/**
 * @file HarvestLogdomain_repositories.ts
 * @description Enterprise-grade implementation for HarvestLog in the domain/repositories layer.
...
import { IHarvestLog } from '../models/HarvestLog';

/**
 * Repository interface for HarvestLog.
 * Follows the Repository pattern to abstract data access.
 */
export interface IHarvestLogRepository {
    findById(id: string): Promise<IHarvestLog | null>;
    findAll(): Promise<IHarvestLog[]>;
    save(entity: IHarvestLog): Promise<void>;
