/**
 * @file TemperatureSensordomain_repositories.ts
 * @description Enterprise-grade implementation for TemperatureSensor in the domain/repositories layer.
...
import { ITemperatureSensor } from '../models/TemperatureSensor';

/**
 * Repository interface for TemperatureSensor.
 * Follows the Repository pattern to abstract data access.
 */
export interface ITemperatureSensorRepository {
    findById(id: string): Promise<ITemperatureSensor | null>;
    findAll(): Promise<ITemperatureSensor[]>;
    save(entity: ITemperatureSensor): Promise<void>;
