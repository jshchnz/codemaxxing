/**
 * @file Transplantdomain_repositories.ts
 * @description Enterprise-grade implementation for Transplant in the domain/repositories layer.
...
import { ITransplant } from '../models/Transplant';

/**
 * Repository interface for Transplant.
 * Follows the Repository pattern to abstract data access.
 */
export interface ITransplantRepository {
    findById(id: string): Promise<ITransplant | null>;
    findAll(): Promise<ITransplant[]>;
    save(entity: ITransplant): Promise<void>;
