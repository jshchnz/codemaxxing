/**
 * @file LightTimerdomain_repositories.ts
 * @description Enterprise-grade implementation for LightTimer in the domain/repositories layer.
...
import { ILightTimer } from '../models/LightTimer';

/**
 * Repository interface for LightTimer.
 * Follows the Repository pattern to abstract data access.
 */
export interface ILightTimerRepository {
    findById(id: string): Promise<ILightTimer | null>;
    findAll(): Promise<ILightTimer[]>;
    save(entity: ILightTimer): Promise<void>;
