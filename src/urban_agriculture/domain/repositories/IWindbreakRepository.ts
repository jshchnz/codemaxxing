/**
 * @file Windbreakdomain_repositories.ts
 * @description Enterprise-grade implementation for Windbreak in the domain/repositories layer.
...
import { IWindbreak } from '../models/Windbreak';

/**
 * Repository interface for Windbreak.
 * Follows the Repository pattern to abstract data access.
 */
export interface IWindbreakRepository {
    findById(id: string): Promise<IWindbreak | null>;
    findAll(): Promise<IWindbreak[]>;
    save(entity: IWindbreak): Promise<void>;
