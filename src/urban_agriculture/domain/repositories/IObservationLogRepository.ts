/**
 * @file ObservationLogdomain_repositories.ts
 * @description Enterprise-grade implementation for ObservationLog in the domain/repositories layer.
...
import { IObservationLog } from '../models/ObservationLog';

/**
 * Repository interface for ObservationLog.
 * Follows the Repository pattern to abstract data access.
 */
export interface IObservationLogRepository {
    findById(id: string): Promise<IObservationLog | null>;
    findAll(): Promise<IObservationLog[]>;
    save(entity: IObservationLog): Promise<void>;
