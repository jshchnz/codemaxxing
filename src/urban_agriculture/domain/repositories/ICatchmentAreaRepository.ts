/**
 * @file CatchmentAreadomain_repositories.ts
 * @description Enterprise-grade implementation for CatchmentArea in the domain/repositories layer.
...
import { ICatchmentArea } from '../models/CatchmentArea';

/**
 * Repository interface for CatchmentArea.
 * Follows the Repository pattern to abstract data access.
 */
export interface ICatchmentAreaRepository {
    findById(id: string): Promise<ICatchmentArea | null>;
    findAll(): Promise<ICatchmentArea[]>;
    save(entity: ICatchmentArea): Promise<void>;
