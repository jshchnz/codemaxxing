/**
 * @file PlantingScheduledomain_repositories.ts
 * @description Enterprise-grade implementation for PlantingSchedule in the domain/repositories layer.
...
import { IPlantingSchedule } from '../models/PlantingSchedule';

/**
 * Repository interface for PlantingSchedule.
 * Follows the Repository pattern to abstract data access.
 */
export interface IPlantingScheduleRepository {
    findById(id: string): Promise<IPlantingSchedule | null>;
    findAll(): Promise<IPlantingSchedule[]>;
    save(entity: IPlantingSchedule): Promise<void>;
