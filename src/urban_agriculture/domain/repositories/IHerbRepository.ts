/**
 * @file Herbdomain_repositories.ts
 * @description Enterprise-grade implementation for Herb in the domain/repositories layer.
...
/**
 * Repository interface for Herb.
 * Follows the Repository pattern to abstract data access.
 */
export interface IHerbRepository {
    findById(id: string): Promise<IHerb | null>;
    findAll(): Promise<IHerb[]>;
    save(entity: IHerb): Promise<void>;
