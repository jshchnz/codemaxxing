/**
 * @file ResourceAuditdomain_repositories.ts
 * @description Enterprise-grade implementation for ResourceAudit in the domain/repositories layer.
...
import { IResourceAudit } from '../models/ResourceAudit';

/**
 * Repository interface for ResourceAudit.
 * Follows the Repository pattern to abstract data access.
 */
export interface IResourceAuditRepository {
    findById(id: string): Promise<IResourceAudit | null>;
    findAll(): Promise<IResourceAudit[]>;
    save(entity: IResourceAudit): Promise<void>;
