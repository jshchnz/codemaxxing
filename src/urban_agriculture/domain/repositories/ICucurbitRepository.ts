/**
 * @file Cucurbitdomain_repositories.ts
 * @description Enterprise-grade implementation for Cucurbit in the domain/repositories layer.
...
import { ICucurbit } from '../models/Cucurbit';

/**
 * Repository interface for Cucurbit.
 * Follows the Repository pattern to abstract data access.
 */
export interface ICucurbitRepository {
    findById(id: string): Promise<ICucurbit | null>;
    findAll(): Promise<ICucurbit[]>;
    save(entity: ICucurbit): Promise<void>;
