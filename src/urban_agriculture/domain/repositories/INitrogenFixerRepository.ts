/**
 * @file NitrogenFixerdomain_repositories.ts
 * @description Enterprise-grade implementation for NitrogenFixer in the domain/repositories layer.
...
import { INitrogenFixer } from '../models/NitrogenFixer';

/**
 * Repository interface for NitrogenFixer.
 * Follows the Repository pattern to abstract data access.
 */
export interface INitrogenFixerRepository {
    findById(id: string): Promise<INitrogenFixer | null>;
    findAll(): Promise<INitrogenFixer[]>;
    save(entity: INitrogenFixer): Promise<void>;
