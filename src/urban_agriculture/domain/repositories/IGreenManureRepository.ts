/**
 * @file GreenManuredomain_repositories.ts
 * @description Enterprise-grade implementation for GreenManure in the domain/repositories layer.
...
import { IGreenManure } from '../models/GreenManure';

/**
 * Repository interface for GreenManure.
 * Follows the Repository pattern to abstract data access.
 */
export interface IGreenManureRepository {
    findById(id: string): Promise<IGreenManure | null>;
    findAll(): Promise<IGreenManure[]>;
    save(entity: IGreenManure): Promise<void>;
