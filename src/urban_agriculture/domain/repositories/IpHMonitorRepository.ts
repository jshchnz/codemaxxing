/**
 * @file pHMonitordomain_repositories.ts
 * @description Enterprise-grade implementation for pHMonitor in the domain/repositories layer.
...
import { IpHMonitor } from '../models/pHMonitor';

/**
 * Repository interface for pHMonitor.
 * Follows the Repository pattern to abstract data access.
 */
export interface IpHMonitorRepository {
    findById(id: string): Promise<IpHMonitor | null>;
    findAll(): Promise<IpHMonitor[]>;
    save(entity: IpHMonitor): Promise<void>;
