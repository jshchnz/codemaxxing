/**
 * @file ContourLinedomain_repositories.ts
 * @description Enterprise-grade implementation for ContourLine in the domain/repositories layer.
...
import { IContourLine } from '../models/ContourLine';

/**
 * Repository interface for ContourLine.
 * Follows the Repository pattern to abstract data access.
 */
export interface IContourLineRepository {
    findById(id: string): Promise<IContourLine | null>;
    findAll(): Promise<IContourLine[]>;
    save(entity: IContourLine): Promise<void>;
