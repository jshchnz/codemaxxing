/**
 * @file Sproutdomain_repositories.ts
 * @description Enterprise-grade implementation for Sprout in the domain/repositories layer.
...
import { ISprout } from '../models/Sprout';

/**
 * Repository interface for Sprout.
 * Follows the Repository pattern to abstract data access.
 */
export interface ISproutRepository {
    findById(id: string): Promise<ISprout | null>;
    findAll(): Promise<ISprout[]>;
    save(entity: ISprout): Promise<void>;
