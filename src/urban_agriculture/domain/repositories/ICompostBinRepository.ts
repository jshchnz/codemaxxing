/**
 * @file CompostBindomain_repositories.ts
 * @description Enterprise-grade implementation for CompostBin in the domain/repositories layer.
...
import { ICompostBin } from '../models/CompostBin';

/**
 * Repository interface for CompostBin.
 * Follows the Repository pattern to abstract data access.
 */
export interface ICompostBinRepository {
    findById(id: string): Promise<ICompostBin | null>;
    findAll(): Promise<ICompostBin[]>;
    save(entity: ICompostBin): Promise<void>;
