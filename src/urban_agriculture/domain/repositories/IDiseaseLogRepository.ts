/**
 * @file DiseaseLogdomain_repositories.ts
 * @description Enterprise-grade implementation for DiseaseLog in the domain/repositories layer.
...
import { IDiseaseLog } from '../models/DiseaseLog';

/**
 * Repository interface for DiseaseLog.
 * Follows the Repository pattern to abstract data access.
 */
export interface IDiseaseLogRepository {
    findById(id: string): Promise<IDiseaseLog | null>;
    findAll(): Promise<IDiseaseLog[]>;
    save(entity: IDiseaseLog): Promise<void>;
