/**
 * @file ShiftPatterndomain_repositories.ts
 * @description Enterprise-grade implementation for ShiftPattern in the domain/repositories layer.
...
import { IShiftPattern } from '../models/ShiftPattern';

/**
 * Repository interface for ShiftPattern.
 * Follows the Repository pattern to abstract data access.
 */
export interface IShiftPatternRepository {
    findById(id: string): Promise<IShiftPattern | null>;
    findAll(): Promise<IShiftPattern[]>;
    save(entity: IShiftPattern): Promise<void>;
