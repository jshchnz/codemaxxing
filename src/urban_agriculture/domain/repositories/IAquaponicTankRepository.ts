/**
 * @file AquaponicTankdomain_repositories.ts
 * @description Enterprise-grade implementation for AquaponicTank in the domain/repositories layer.
...
import { IAquaponicTank } from '../models/AquaponicTank';

/**
 * Repository interface for AquaponicTank.
 * Follows the Repository pattern to abstract data access.
 */
export interface IAquaponicTankRepository {
    findById(id: string): Promise<IAquaponicTank | null>;
    findAll(): Promise<IAquaponicTank[]>;
    save(entity: IAquaponicTank): Promise<void>;
