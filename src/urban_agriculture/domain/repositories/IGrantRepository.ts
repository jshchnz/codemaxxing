/**
 * @file Grantdomain_repositories.ts
 * @description Enterprise-grade implementation for Grant in the domain/repositories layer.
...
/**
 * Repository interface for Grant.
...
export interface IGrantRepository {
    ...
    save(entity: IGrant): Promise<void>;
