/**
 * @file Pollinatordomain_repositories.ts
 * @description Enterprise-grade implementation for Pollinator in the domain/repositories layer.
...
import { IPollinator } from '../models/Pollinator';

/**
 * Repository interface for Pollinator.
 * Follows the Repository pattern to abstract data access.
 */
export interface IPollinatorRepository {
    findById(id: string): Promise<IPollinator | null>;
    findAll(): Promise<IPollinator[]>;
    save(entity: IPollinator): Promise<void>;
