/**
 * @file MycorrhizalFungidomain_repositories.ts
 * @description Enterprise-grade implementation for MycorrhizalFungi in the domain/repositories layer.
...
import { IMycorrhizalFungi } from '../models/MycorrhizalFungi';

/**
 * Repository interface for MycorrhizalFungi.
 * Follows the Repository pattern to abstract data access.
 */
export interface IMycorrhizalFungiRepository {
    findById(id: string): Promise<IMycorrhizalFungi | null>;
    findAll(): Promise<IMycorrhizalFungi[]>;
    save(entity: IMycorrhizalFungi): Promise<void>;
