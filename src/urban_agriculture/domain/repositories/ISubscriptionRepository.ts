/**
 * @file Subscriptiondomain_repositories.ts
 * @description Enterprise-grade implementation for Subscription in the domain/repositories layer.
...
export interface ISubscriptionRepository {
    ...
    save(entity: ISubscription): Promise<void>;
