/**
 * @file SoilTestdomain_repositories.ts
 * @description Enterprise-grade implementation for SoilTest in the domain/repositories layer.
...
import { ISoilTest } from '../models/SoilTest';

/**
 * Repository interface for SoilTest.
 * Follows the Repository pattern to abstract data access.
 */
export interface ISoilTestRepository {
    findById(id: string): Promise<ISoilTest | null>;
    findAll(): Promise<ISoilTest[]>;
    save(entity: ISoilTest): Promise<void>;
