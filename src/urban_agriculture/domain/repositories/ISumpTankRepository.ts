/**
 * @file SumpTankdomain_repositories.ts
 * @description Enterprise-grade implementation for SumpTank in the domain/repositories layer.
...
import { ISumpTank } from '../models/SumpTank';

/**
 * Repository interface for SumpTank.
 * Follows the Repository pattern to abstract data access.
 */
export interface ISumpTankRepository {
    findById(id: string): Promise<ISumpTank | null>;
    findAll(): Promise<ISumpTank[]>;
    save(entity: ISumpTank): Promise<void>;
