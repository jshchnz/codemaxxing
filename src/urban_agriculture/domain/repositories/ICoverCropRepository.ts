/**
 * @file CoverCropdomain_repositories.ts
 * @description Enterprise-grade implementation for CoverCrop in the domain/repositories layer.
...
import { ICoverCrop } from '../models/CoverCrop';

/**
 * Repository interface for CoverCrop.
 * Follows the Repository pattern to abstract data access.
 */
export interface ICoverCropRepository {
    findById(id: string): Promise<ICoverCrop | null>;
    findAll(): Promise<ICoverCrop[]>;
    save(entity: ICoverCrop): Promise<void>;
