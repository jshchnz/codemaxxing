/**
 * @file Microgreendomain_repositories.ts
 * @description Enterprise-grade implementation for Microgreen in the domain/repositories layer.
...
import { IMicrogreen } from '../models/Microgreen';

/**
 * Repository interface for Microgreen.
 * Follows the Repository pattern to abstract data access.
 */
export interface IMicrogreenRepository {
    findById(id: string): Promise<IMicrogreen | null>;
    findAll(): Promise<IMicrogreen[]>;
    save(entity: IMicrogreen): Promise<void>;
