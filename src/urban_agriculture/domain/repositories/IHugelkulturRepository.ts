/**
 * @file Hugelkulturdomain_repositories.ts
 * @description Enterprise-grade implementation for Hugelkultur in the domain/repositories layer.
...
import { IHugelkultur } from '../models/Hugelkultur';

/**
 * Repository interface for Hugelkultur.
 * Follows the Repository pattern to abstract data access.
 */
export interface IHugelkulturRepository {
    findById(id: string): Promise<IHugelkultur | null>;
    findAll(): Promise<IHugelkultur[]>;
    save(entity: IHugelkultur): Promise<void>;
