/**
 * @file ToolLibrarydomain_repositories.ts
 * @description Enterprise-grade implementation for ToolLibrary in the domain/repositories layer.
...
import { IToolLibrary } from '../models/ToolLibrary';

/**
 * Repository interface for ToolLibrary.
 * Follows the Repository pattern to abstract data access.
 */
export interface IToolLibraryRepository {
    findById(id: string): Promise<IToolLibrary | null>;
    findAll(): Promise<IToolLibrary[]>;
    save(entity: IToolLibrary): Promise<void>;
