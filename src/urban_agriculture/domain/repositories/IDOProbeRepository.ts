/**
 * @file DOProbedomain_repositories.ts
 * @description Enterprise-grade implementation for DOProbe in the domain/repositories layer.
...
import { IDOProbe } from '../models/DOProbe';

/**
 * Repository interface for DOProbe.
 * Follows the Repository pattern to abstract data access.
 */
export interface IDOProbeRepository {
    findById(id: string): Promise<IDOProbe | null>;
    findAll(): Promise<IDOProbe[]>;
    save(entity: IDOProbe): Promise<void>;
