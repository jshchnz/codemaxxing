/**
 * @file RootCropdomain_repositories.ts
 * @description Enterprise-grade implementation for RootCrop in the domain/repositories layer.
...
import { IRootCrop } from '../models/RootCrop';

/**
 * Repository interface for RootCrop.
 * Follows the Repository pattern to abstract data access.
 */
export interface IRootCropRepository {
    findById(id: string): Promise<IRootCrop | null>;
    findAll(): Promise<IRootCrop[]>;
    save(entity: IRootCrop): Promise<void>;
