/**
 * @file CompanionPlantingdomain_repositories.ts
 * @description Enterprise-grade implementation for CompanionPlanting in the domain/repositories layer.
...
import { ICompanionPlanting } from '../models/CompanionPlanting';

/**
 * Repository interface for CompanionPlanting.
 * Follows the Repository pattern to abstract data access.
 */
export interface ICompanionPlantingRepository {
    findById(id: string): Promise<ICompanionPlanting | null>;
    findAll(): Promise<ICompanionPlanting[]>;
    save(entity: ICompanionPlanting): Promise<void>;
