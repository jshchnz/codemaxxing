/**
 * @file EnergyFlowdomain_repositories.ts
 * @description Enterprise-grade implementation for EnergyFlow in the domain/repositories layer.
...
import { IEnergyFlow } from '../models/EnergyFlow';

/**
 * Repository interface for EnergyFlow.
 * Follows the Repository pattern to abstract data access.
 */
export interface IEnergyFlowRepository {
    findById(id: string): Promise<IEnergyFlow | null>;
    findAll(): Promise<IEnergyFlow[]>;
    save(entity: IEnergyFlow): Promise<void>;
