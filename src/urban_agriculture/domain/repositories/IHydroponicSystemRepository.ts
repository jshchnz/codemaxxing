/**
 * @file HydroponicSystemdomain_repositories.ts
 * @description Enterprise-grade implementation for HydroponicSystem in the domain/repositories layer.
...
import { IHydroponicSystem } from '../models/HydroponicSystem';

/**
 * Repository interface for HydroponicSystem.
 * Follows the Repository pattern to abstract data access.
 */
export interface IHydroponicSystemRepository {
    findById(id: string): Promise<IHydroponicSystem | null>;
    findAll(): Promise<IHydroponicSystem[]>;
    save(entity: IHydroponicSystem): Promise<void>;
