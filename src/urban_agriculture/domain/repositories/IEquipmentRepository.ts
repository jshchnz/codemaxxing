/**
 * @file Equipmentdomain_repositories.ts
 * @description Enterprise-grade implementation for Equipment in the domain/repositories layer.
...
export interface IEquipmentRepository {
    ...
    save(entity: IEquipment): Promise<void>;
