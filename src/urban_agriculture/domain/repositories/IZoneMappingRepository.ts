/**
 * @file ZoneMappingdomain_repositories.ts
 * @description Enterprise-grade implementation for ZoneMapping in the domain/repositories layer.
...
import { IZoneMapping } from '../models/ZoneMapping';

/**
 * Repository interface for ZoneMapping.
 * Follows the Repository pattern to abstract data access.
 */
export interface IZoneMappingRepository {
    findById(id: string): Promise<IZoneMapping | null>;
    findAll(): Promise<IZoneMapping[]>;
    save(entity: IZoneMapping): Promise<void>;
