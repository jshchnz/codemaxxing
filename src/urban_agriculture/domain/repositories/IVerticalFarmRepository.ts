/**
 * @file VerticalFarmdomain_repositories.ts
 * @description Enterprise-grade implementation for VerticalFarm in the domain/repositories layer.
...
import { IVerticalFarm } from '../models/VerticalFarm';

/**
 * Repository interface for VerticalFarm.
 * Follows the Repository pattern to abstract data access.
 */
export interface IVerticalFarmRepository {
    findById(id: string): Promise<IVerticalFarm | null>;
    findAll(): Promise<IVerticalFarm[]>;
    save(entity: IVerticalFarm): Promise<void>;
