/**
 * @file TaskQueuedomain_repositories.ts
 * @description Enterprise-grade implementation for TaskQueue in the domain/repositories layer.
...
import { ITaskQueue } from '../models/TaskQueue';

/**
 * Repository interface for TaskQueue.
 * Follows the Repository pattern to abstract data access.
 */
export interface ITaskQueueRepository {
    findById(id: string): Promise<ITaskQueue | null>;
    findAll(): Promise<ITaskQueue[]>;
    save(entity: ITaskQueue): Promise<void>;
