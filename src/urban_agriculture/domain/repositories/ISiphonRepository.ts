/**
 * @file Siphondomain_repositories.ts
 * @description Enterprise-grade implementation for Siphon in the domain/repositories layer.
...
import { ISiphon } from '../models/Siphon';

/**
 * Repository interface for Siphon.
 * Follows the Repository pattern to abstract data access.
 */
export interface ISiphonRepository {
    findById(id: string): Promise<ISiphon | null>;
    findAll(): Promise<ISiphon[]>;
    save(entity: ISiphon): Promise<void>;
