/**
 * @file Solanaceaedomain_repositories.ts
 * @description Enterprise-grade implementation for Solanaceae in the domain/repositories layer.
...
import { ISolanaceae } from '../models/Solanaceae';

/**
 * Repository interface for Solanaceae.
 * Follows the Repository pattern to abstract data access.
 */
export interface ISolanaceaeRepository {
    findById(id: string): Promise<ISolanaceae | null>;
    findAll(): Promise<ISolanaceae[]>;
    save(entity: ISolanaceae): Promise<void>;
