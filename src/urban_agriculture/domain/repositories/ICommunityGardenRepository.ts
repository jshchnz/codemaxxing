/**
 * @file CommunityGardendomain_repositories.ts
 * @description Enterprise-grade implementation for CommunityGarden in the domain/repositories layer.
...
import { ICommunityGarden } from '../models/CommunityGarden';

/**
 * Repository interface for CommunityGarden.
 * Follows the Repository pattern to abstract data access.
 */
export interface ICommunityGardenRepository {
    findById(id: string): Promise<ICommunityGarden | null>;
    findAll(): Promise<ICommunityGarden[]>;
    save(entity: ICommunityGarden): Promise<void>;
