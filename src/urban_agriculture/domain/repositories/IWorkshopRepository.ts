/**
 * @file Workshopdomain_repositories.ts
 * @description Enterprise-grade implementation for Workshop in the domain/repositories layer.
...
/**
 * Repository interface for Workshop.
...
export interface IWorkshopRepository {
    ...
    findAll(): Promise<IWorkshop[]>;
    save(entity: IWorkshop): Promise<void>;
