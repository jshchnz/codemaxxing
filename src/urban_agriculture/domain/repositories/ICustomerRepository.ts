/**
 * @file Customerdomain_repositories.ts
 * @description Enterprise-grade implementation for Customer in the domain/repositories layer.
...
export interface ICustomerRepository {
    ...
    save(entity: ICustomer): Promise<void>;
