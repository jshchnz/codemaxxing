/**
 * @file Vegetabledomain_repositories.ts
 * @description Enterprise-grade implementation for Vegetable in the domain/repositories layer.
...
import { IVegetable } from '../models/Vegetable';

/**
 * Repository interface for Vegetable.
 * Follows the Repository pattern to abstract data access.
 */
export interface IVegetableRepository {
    findById(id: string): Promise<IVegetable | null>;
    findAll(): Promise<IVegetable[]>;
    save(entity: IVegetable): Promise<void>;
