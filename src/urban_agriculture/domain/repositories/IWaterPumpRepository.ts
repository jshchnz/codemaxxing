/**
 * @file WaterPumpdomain_repositories.ts
 * @description Enterprise-grade implementation for WaterPump in the domain/repositories layer.
...
import { IWaterPump } from '../models/WaterPump';

/**
 * Repository interface for WaterPump.
 * Follows the Repository pattern to abstract data access.
 */
export interface IWaterPumpRepository {
    findById(id: string): Promise<IWaterPump | null>;
    findAll(): Promise<IWaterPump[]>;
    save(entity: IWaterPump): Promise<void>;
