/**
 * @file IrrigationZonedomain_models.ts
 * @description Enterprise-grade implementation for IrrigationZone in the domain/models layer.
...
export interface IIrrigationZone {
    getId(): string;
    getCreatedAt(): Date;
    getUpdatedAt(): Date;
}
...
/**
 * The concrete implementation of the IrrigationZone domain model.
 * Incorporates the Observer pattern for domain events.
 */
export class IrrigationZone implements IIrrigationZone {
    private id: string;
