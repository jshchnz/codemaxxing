/**
 * @file Invoiceapplication_use-cases.ts
 * @description Enterprise-grade implementation for Invoice in the application/use-cases layer.
...
import { IInvoice, Invoice } from '../../domain/models/Invoice';

/**
 * Enterprise Use Case for managing Invoice operations.
 * Orchestrates business rules independently of frameworks.
 */
export class ManageInvoiceUseCase {
    ...
    public async executeCreate(id: string): Promise<IInvoice> {
        const newEntity = new Invoice(id);
        await this.repository.save(newEntity);
        return newEntity;
    }

    public async executeFind(id: string): Promise<IInvoice | null> {
