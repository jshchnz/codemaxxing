/**
 * @file Equipmentapplication_use-cases.ts
 * @description Enterprise-grade implementation for Equipment in the application/use-cases layer.
...
import { IEquipment, Equipment } from '../../domain/models/Equipment';

/**
 * Enterprise Use Case for managing Equipment operations.
 * Orchestrates business rules independently of frameworks.
 */
export class ManageEquipmentUseCase {
    ...
    public async executeCreate(id: string): Promise<IEquipment> {
        const newEntity = new Equipment(id);
        await this.repository.save(newEntity);
        return newEntity;
    }

    public async executeFind(id: string): Promise<IEquipment | null> {
