/**
 * @file SoilAmendmentsinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for SoilAmendments in the infrastructure/repositories layer.
...
import { ISoilAmendmentsRepository } from '../../domain/repositories/ISoilAmendmentsRepository';
import { ISoilAmendments } from '../../domain/models/SoilAmendments';

/**
 * Concrete implementation of ISoilAmendmentsRepository using abstract infrastructure.
 */
export class SoilAmendmentsRepositoryImpl implements ISoilAmendmentsRepository {
    private storage: Map<string, ISoilAmendments> = new Map();

    public async findById(id: string): Promise<ISoilAmendments | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<ISoilAmendments[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: ISoilAmendments): Promise<void> {
