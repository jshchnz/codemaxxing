/**
 * @file MycorrhizalFungiinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for MycorrhizalFungi in the infrastructure/repositories layer.
...
import { IMycorrhizalFungiRepository } from '../../domain/repositories/IMycorrhizalFungiRepository';
import { IMycorrhizalFungi } from '../../domain/models/MycorrhizalFungi';

/**
 * Concrete implementation of IMycorrhizalFungiRepository using abstract infrastructure.
 */
export class MycorrhizalFungiRepositoryImpl implements IMycorrhizalFungiRepository {
    private storage: Map<string, IMycorrhizalFungi> = new Map();

    public async findById(id: string): Promise<IMycorrhizalFungi | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<IMycorrhizalFungi[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: IMycorrhizalFungi): Promise<void> {
