/**
 * @file IrrigationZoneinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for IrrigationZone in the infrastructure/repositories layer.
...
import { IIrrigationZoneRepository } from '../../domain/repositories/IIrrigationZoneRepository';
import { IIrrigationZone } from '../../domain/models/IrrigationZone';

/**
 * Concrete implementation of IIrrigationZoneRepository using abstract infrastructure.
 */
export class IrrigationZoneRepositoryImpl implements IIrrigationZoneRepository {
    private storage: Map<string, IIrrigationZone> = new Map();

    public async findById(id: string): Promise<IIrrigationZone | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<IIrrigationZone[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: IIrrigationZone): Promise<void> {
