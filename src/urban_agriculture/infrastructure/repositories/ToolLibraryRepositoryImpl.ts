/**
 * @file ToolLibraryinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for ToolLibrary in the infrastructure/repositories layer.
...
import { IToolLibraryRepository } from '../../domain/repositories/IToolLibraryRepository';
import { IToolLibrary } from '../../domain/models/ToolLibrary';

/**
 * Concrete implementation of IToolLibraryRepository using abstract infrastructure.
 */
export class ToolLibraryRepositoryImpl implements IToolLibraryRepository {
    private storage: Map<string, IToolLibrary> = new Map();

    public async findById(id: string): Promise<IToolLibrary | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<IToolLibrary[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: IToolLibrary): Promise<void> {
