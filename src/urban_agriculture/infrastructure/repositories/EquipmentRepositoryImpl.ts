/**
 * @file Equipmentinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for Equipment in the infrastructure/repositories layer.
...
import { IEquipment } from '../../domain/models/Equipment';

/**
 * Concrete implementation of IEquipmentRepository using abstract infrastructure.
 */
export class EquipmentRepositoryImpl implements IEquipmentRepository {
    private storage: Map<string, IEquipment> = new Map();

    public async findById(id: string): Promise<IEquipment | null> {
    ...
    public async save(entity: IEquipment): Promise<void> {
