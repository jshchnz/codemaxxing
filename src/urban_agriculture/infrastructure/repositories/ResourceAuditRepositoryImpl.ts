/**
 * @file ResourceAuditinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for ResourceAudit in the infrastructure/repositories layer.
...
import { IResourceAuditRepository } from '../../domain/repositories/IResourceAuditRepository';
import { IResourceAudit } from '../../domain/models/ResourceAudit';

/**
 * Concrete implementation of IResourceAuditRepository using abstract infrastructure.
 */
export class ResourceAuditRepositoryImpl implements IResourceAuditRepository {
    private storage: Map<string, IResourceAudit> = new Map();

    public async findById(id: string): Promise<IResourceAudit | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<IResourceAudit[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: IResourceAudit): Promise<void> {
