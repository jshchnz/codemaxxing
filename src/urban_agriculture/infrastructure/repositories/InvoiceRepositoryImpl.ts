/**
 * @file Invoiceinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for Invoice in the infrastructure/repositories layer.
...
import { IInvoice } from '../../domain/models/Invoice';

/**
 * Concrete implementation of IInvoiceRepository using abstract infrastructure.
 */
export class InvoiceRepositoryImpl implements IInvoiceRepository {
    private storage: Map<string, IInvoice> = new Map();

    public async findById(id: string): Promise<IInvoice | null> {
    ...
    public async save(entity: IInvoice): Promise<void> {
