/**
 * @file TemperatureSensorinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for TemperatureSensor in the infrastructure/repositories layer.
...
import { ITemperatureSensorRepository } from '../../domain/repositories/ITemperatureSensorRepository';
import { ITemperatureSensor } from '../../domain/models/TemperatureSensor';

/**
 * Concrete implementation of ITemperatureSensorRepository using abstract infrastructure.
 */
export class TemperatureSensorRepositoryImpl implements ITemperatureSensorRepository {
    private storage: Map<string, ITemperatureSensor> = new Map();

    public async findById(id: string): Promise<ITemperatureSensor | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<ITemperatureSensor[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: ITemperatureSensor): Promise<void> {
