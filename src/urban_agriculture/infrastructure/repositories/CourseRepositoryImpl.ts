/**
 * @file Courseinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for Course in the infrastructure/repositories layer.
...
/**
 * Concrete implementation of ICourseRepository using abstract infrastructure.
 */
