/**
 * @file LeafyGreeninfrastructure_repositories.ts
 * @description Enterprise-grade implementation for LeafyGreen in the infrastructure/repositories layer.
...
import { ILeafyGreenRepository } from '../../domain/repositories/ILeafyGreenRepository';
import { ILeafyGreen } from '../../domain/models/LeafyGreen';

/**
 * Concrete implementation of ILeafyGreenRepository using abstract infrastructure.
 */
export class LeafyGreenRepositoryImpl implements ILeafyGreenRepository {
    private storage: Map<string, ILeafyGreen> = new Map();

    public async findById(id: string): Promise<ILeafyGreen | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<ILeafyGreen[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: ILeafyGreen): Promise<void> {
