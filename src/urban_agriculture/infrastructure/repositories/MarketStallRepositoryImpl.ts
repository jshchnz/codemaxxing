/**
 * @file MarketStallinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for MarketStall in the infrastructure/repositories layer.
...
import { IMarketStallRepository } from '../../domain/repositories/IMarketStallRepository';
import { IMarketStall } from '../../domain/models/MarketStall';

/**
 * Concrete implementation of IMarketStallRepository using abstract infrastructure.
 */
export class MarketStallRepositoryImpl implements IMarketStallRepository {
    private storage: Map<string, IMarketStall> = new Map();

    public async findById(id: string): Promise<IMarketStall | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<IMarketStall[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: IMarketStall): Promise<void> {
