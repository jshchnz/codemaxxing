/**
 * @file ZoneMappinginfrastructure_repositories.ts
 * @description Enterprise-grade implementation for ZoneMapping in the infrastructure/repositories layer.
...
import { IZoneMappingRepository } from '../../domain/repositories/IZoneMappingRepository';
import { IZoneMapping } from '../../domain/models/ZoneMapping';

/**
 * Concrete implementation of IZoneMappingRepository using abstract infrastructure.
 */
export class ZoneMappingRepositoryImpl implements IZoneMappingRepository {
    private storage: Map<string, IZoneMapping> = new Map();

    public async findById(id: string): Promise<IZoneMapping | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<IZoneMapping[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: IZoneMapping): Promise<void> {
