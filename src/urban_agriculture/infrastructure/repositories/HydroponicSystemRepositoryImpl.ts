/**
 * @file HydroponicSysteminfrastructure_repositories.ts
 * @description Enterprise-grade implementation for HydroponicSystem in the infrastructure/repositories layer.
...
import { IHydroponicSystemRepository } from '../../domain/repositories/IHydroponicSystemRepository';
import { IHydroponicSystem } from '../../domain/models/HydroponicSystem';

/**
 * Concrete implementation of IHydroponicSystemRepository using abstract infrastructure.
 */
export class HydroponicSystemRepositoryImpl implements IHydroponicSystemRepository {
    private storage: Map<string, IHydroponicSystem> = new Map();

    public async findById(id: string): Promise<IHydroponicSystem | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<IHydroponicSystem[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: IHydroponicSystem): Promise<void> {
