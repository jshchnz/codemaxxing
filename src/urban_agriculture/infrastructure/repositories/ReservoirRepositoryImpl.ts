/**
 * @file Reservoirinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for Reservoir in the infrastructure/repositories layer.
...
import { IReservoirRepository } from '../../domain/repositories/IReservoirRepository';
import { IReservoir } from '../../domain/models/Reservoir';

/**
 * Concrete implementation of IReservoirRepository using abstract infrastructure.
 */
export class ReservoirRepositoryImpl implements IReservoirRepository {
    private storage: Map<string, IReservoir> = new Map();

    public async findById(id: string): Promise<IReservoir | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<IReservoir[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: IReservoir): Promise<void> {
