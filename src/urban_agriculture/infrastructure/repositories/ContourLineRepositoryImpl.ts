/**
 * @file ContourLineinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for ContourLine in the infrastructure/repositories layer.
...
import { IContourLineRepository } from '../../domain/repositories/IContourLineRepository';
import { IContourLine } from '../../domain/models/ContourLine';

/**
 * Concrete implementation of IContourLineRepository using abstract infrastructure.
 */
export class ContourLineRepositoryImpl implements IContourLineRepository {
    private storage: Map<string, IContourLine> = new Map();

    public async findById(id: string): Promise<IContourLine | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<IContourLine[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: IContourLine): Promise<void> {
