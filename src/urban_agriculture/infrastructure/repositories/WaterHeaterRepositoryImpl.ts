/**
 * @file WaterHeaterinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for WaterHeater in the infrastructure/repositories layer.
...
import { IWaterHeaterRepository } from '../../domain/repositories/IWaterHeaterRepository';
import { IWaterHeater } from '../../domain/models/WaterHeater';

/**
 * Concrete implementation of IWaterHeaterRepository using abstract infrastructure.
 */
export class WaterHeaterRepositoryImpl implements IWaterHeaterRepository {
    private storage: Map<string, IWaterHeater> = new Map();

    public async findById(id: string): Promise<IWaterHeater | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<IWaterHeater[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: IWaterHeater): Promise<void> {
