/**
 * @file Memberinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for Member in the infrastructure/repositories layer.
...
import { IMember } from '../../domain/models/Member';

/**
 * Concrete implementation of IMemberRepository using abstract infrastructure.
 */
export class MemberRepositoryImpl implements IMemberRepository {
    private storage: Map<string, IMember> = new Map();
    ...
    public async save(entity: IMember): Promise<void> {
