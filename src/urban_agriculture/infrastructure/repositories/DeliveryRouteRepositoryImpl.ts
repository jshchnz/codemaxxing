/**
 * @file DeliveryRouteinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for DeliveryRoute in the infrastructure/repositories layer.
...
import { IDeliveryRouteRepository } from '../../domain/repositories/IDeliveryRouteRepository';
import { IDeliveryRoute } from '../../domain/models/DeliveryRoute';

/**
 * Concrete implementation of IDeliveryRouteRepository using abstract infrastructure.
 */
export class DeliveryRouteRepositoryImpl implements IDeliveryRouteRepository {
    private storage: Map<string, IDeliveryRoute> = new Map();

    public async findById(id: string): Promise<IDeliveryRoute | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<IDeliveryRoute[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: IDeliveryRoute): Promise<void> {
