/**
 * @file PumpScheduleinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for PumpSchedule in the infrastructure/repositories layer.
...
import { IPumpScheduleRepository } from '../../domain/repositories/IPumpScheduleRepository';
import { IPumpSchedule } from '../../domain/models/PumpSchedule';

/**
 * Concrete implementation of IPumpScheduleRepository using abstract infrastructure.
 */
export class PumpScheduleRepositoryImpl implements IPumpScheduleRepository {
    private storage: Map<string, IPumpSchedule> = new Map();

    public async findById(id: string): Promise<IPumpSchedule | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<IPumpSchedule[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: IPumpSchedule): Promise<void> {
