/**
 * @file ObservationLoginfrastructure_repositories.ts
 * @description Enterprise-grade implementation for ObservationLog in the infrastructure/repositories layer.
...
import { IObservationLogRepository } from '../../domain/repositories/IObservationLogRepository';
import { IObservationLog } from '../../domain/models/ObservationLog';

/**
 * Concrete implementation of IObservationLogRepository using abstract infrastructure.
 */
export class ObservationLogRepositoryImpl implements IObservationLogRepository {
    private storage: Map<string, IObservationLog> = new Map();

    public async findById(id: string): Promise<IObservationLog | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<IObservationLog[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: IObservationLog): Promise<void> {
