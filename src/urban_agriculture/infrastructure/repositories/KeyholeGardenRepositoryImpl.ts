/**
 * @file KeyholeGardeninfrastructure_repositories.ts
 * @description Enterprise-grade implementation for KeyholeGarden in the infrastructure/repositories layer.
...
import { IKeyholeGardenRepository } from '../../domain/repositories/IKeyholeGardenRepository';
import { IKeyholeGarden } from '../../domain/models/KeyholeGarden';

/**
 * Concrete implementation of IKeyholeGardenRepository using abstract infrastructure.
 */
export class KeyholeGardenRepositoryImpl implements IKeyholeGardenRepository {
    private storage: Map<string, IKeyholeGarden> = new Map();

    public async findById(id: string): Promise<IKeyholeGarden | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<IKeyholeGarden[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: IKeyholeGarden): Promise<void> {
