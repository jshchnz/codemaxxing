/**
 * @file MaintenanceTaskinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for MaintenanceTask in the infrastructure/repositories layer.
...
import { IMaintenanceTaskRepository } from '../../domain/repositories/IMaintenanceTaskRepository';
import { IMaintenanceTask } from '../../domain/models/MaintenanceTask';

/**
 * Concrete implementation of IMaintenanceTaskRepository using abstract infrastructure.
 */
export class MaintenanceTaskRepositoryImpl implements IMaintenanceTaskRepository {
    private storage: Map<string, IMaintenanceTask> = new Map();

    public async findById(id: string): Promise<IMaintenanceTask | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<IMaintenanceTask[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: IMaintenanceTask): Promise<void> {
