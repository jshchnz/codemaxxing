/**
 * @file Microclimateinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for Microclimate in the infrastructure/repositories layer.
...
import { IMicroclimateRepository } from '../../domain/repositories/IMicroclimateRepository';
import { IMicroclimate } from '../../domain/models/Microclimate';

/**
 * Concrete implementation of IMicroclimateRepository using abstract infrastructure.
 */
export class MicroclimateRepositoryImpl implements IMicroclimateRepository {
    private storage: Map<string, IMicroclimate> = new Map();

    public async findById(id: string): Promise<IMicroclimate | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<IMicroclimate[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: IMicroclimate): Promise<void> {
