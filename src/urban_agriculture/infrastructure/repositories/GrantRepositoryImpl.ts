/**
 * @file Grantinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for Grant in the infrastructure/repositories layer.
...
import { IGrantRepository } from '../../domain/repositories/IGrantRepository';
import { IGrant } from '../../domain/models/Grant';

/**
 * Concrete implementation of IGrantRepository using abstract infrastructure.
 */
export class GrantRepositoryImpl implements IGrantRepository {
    private storage: Map<string, IGrant> = new Map();

    public async findById(id: string): Promise<IGrant | null> {
    ...
    public async save(entity: IGrant): Promise<void> {
