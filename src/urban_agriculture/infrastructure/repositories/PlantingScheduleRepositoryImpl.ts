/**
 * @file PlantingScheduleinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for PlantingSchedule in the infrastructure/repositories layer.
...
import { IPlantingScheduleRepository } from '../../domain/repositories/IPlantingScheduleRepository';
import { IPlantingSchedule } from '../../domain/models/PlantingSchedule';

/**
 * Concrete implementation of IPlantingScheduleRepository using abstract infrastructure.
 */
export class PlantingScheduleRepositoryImpl implements IPlantingScheduleRepository {
    private storage: Map<string, IPlantingSchedule> = new Map();

    public async findById(id: string): Promise<IPlantingSchedule | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<IPlantingSchedule[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: IPlantingSchedule): Promise<void> {
