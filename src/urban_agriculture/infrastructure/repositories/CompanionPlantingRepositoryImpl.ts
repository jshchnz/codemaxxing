/**
 * @file CompanionPlantinginfrastructure_repositories.ts
 * @description Enterprise-grade implementation for CompanionPlanting in the infrastructure/repositories layer.
...
import { ICompanionPlantingRepository } from '../../domain/repositories/ICompanionPlantingRepository';
import { ICompanionPlanting } from '../../domain/models/CompanionPlanting';

/**
 * Concrete implementation of ICompanionPlantingRepository using abstract infrastructure.
 */
export class CompanionPlantingRepositoryImpl implements ICompanionPlantingRepository {
    private storage: Map<string, ICompanionPlanting> = new Map();

    public async findById(id: string): Promise<ICompanionPlanting | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<ICompanionPlanting[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: ICompanionPlanting): Promise<void> {
