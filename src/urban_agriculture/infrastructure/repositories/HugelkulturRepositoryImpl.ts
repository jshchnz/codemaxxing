/**
 * @file Hugelkulturinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for Hugelkultur in the infrastructure/repositories layer.
...
import { IHugelkulturRepository } from '../../domain/repositories/IHugelkulturRepository';
import { IHugelkultur } from '../../domain/models/Hugelkultur';

/**
 * Concrete implementation of IHugelkulturRepository using abstract infrastructure.
 */
export class HugelkulturRepositoryImpl implements IHugelkulturRepository {
    private storage: Map<string, IHugelkultur> = new Map();

    public async findById(id: string): Promise<IHugelkultur | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<IHugelkultur[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: IHugelkultur): Promise<void> {
