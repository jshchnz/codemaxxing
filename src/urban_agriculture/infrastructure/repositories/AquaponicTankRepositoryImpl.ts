/**
 * @file AquaponicTankinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for AquaponicTank in the infrastructure/repositories layer.
...
import { IAquaponicTankRepository } from '../../domain/repositories/IAquaponicTankRepository';
import { IAquaponicTank } from '../../domain/models/AquaponicTank';

/**
 * Concrete implementation of IAquaponicTankRepository using abstract infrastructure.
 */
export class AquaponicTankRepositoryImpl implements IAquaponicTankRepository {
    private storage: Map<string, IAquaponicTank> = new Map();

    public async findById(id: string): Promise<IAquaponicTank | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<IAquaponicTank[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: IAquaponicTank): Promise<void> {
