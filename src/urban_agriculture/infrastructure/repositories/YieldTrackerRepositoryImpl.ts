/**
 * @file YieldTrackerinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for YieldTracker in the infrastructure/repositories layer.
...
import { IYieldTrackerRepository } from '../../domain/repositories/IYieldTrackerRepository';
import { IYieldTracker } from '../../domain/models/YieldTracker';

/**
 * Concrete implementation of IYieldTrackerRepository using abstract infrastructure.
 */
export class YieldTrackerRepositoryImpl implements IYieldTrackerRepository {
    private storage: Map<string, IYieldTracker> = new Map();

    public async findById(id: string): Promise<IYieldTracker | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<IYieldTracker[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: IYieldTracker): Promise<void> {
