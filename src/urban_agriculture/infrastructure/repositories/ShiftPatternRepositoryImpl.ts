/**
 * @file ShiftPatterninfrastructure_repositories.ts
 * @description Enterprise-grade implementation for ShiftPattern in the infrastructure/repositories layer.
...
import { IShiftPatternRepository } from '../../domain/repositories/IShiftPatternRepository';
import { IShiftPattern } from '../../domain/models/ShiftPattern';

/**
 * Concrete implementation of IShiftPatternRepository using abstract infrastructure.
 */
export class ShiftPatternRepositoryImpl implements IShiftPatternRepository {
    private storage: Map<string, IShiftPattern> = new Map();

    public async findById(id: string): Promise<IShiftPattern | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<IShiftPattern[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: IShiftPattern): Promise<void> {
