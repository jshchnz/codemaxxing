/**
 * @file Brassicainfrastructure_repositories.ts
 * @description Enterprise-grade implementation for Brassica in the infrastructure/repositories layer.
...
import { IBrassicaRepository } from '../../domain/repositories/IBrassicaRepository';
import { IBrassica } from '../../domain/models/Brassica';

/**
 * Concrete implementation of IBrassicaRepository using abstract infrastructure.
 */
export class BrassicaRepositoryImpl implements IBrassicaRepository {
    private storage: Map<string, IBrassica> = new Map();

    public async findById(id: string): Promise<IBrassica | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<IBrassica[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: IBrassica): Promise<void> {
