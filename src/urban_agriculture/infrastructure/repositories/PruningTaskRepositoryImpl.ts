/**
 * @file PruningTaskinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for PruningTask in the infrastructure/repositories layer.
...
import { IPruningTaskRepository } from '../../domain/repositories/IPruningTaskRepository';
import { IPruningTask } from '../../domain/models/PruningTask';

/**
 * Concrete implementation of IPruningTaskRepository using abstract infrastructure.
 */
export class PruningTaskRepositoryImpl implements IPruningTaskRepository {
    private storage: Map<string, IPruningTask> = new Map();

    public async findById(id: string): Promise<IPruningTask | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<IPruningTask[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: IPruningTask): Promise<void> {
