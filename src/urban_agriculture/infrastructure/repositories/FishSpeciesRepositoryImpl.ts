/**
 * @file FishSpeciesinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for FishSpecies in the infrastructure/repositories layer.
...
import { IFishSpeciesRepository } from '../../domain/repositories/IFishSpeciesRepository';
import { IFishSpecies } from '../../domain/models/FishSpecies';

/**
 * Concrete implementation of IFishSpeciesRepository using abstract infrastructure.
 */
export class FishSpeciesRepositoryImpl implements IFishSpeciesRepository {
    private storage: Map<string, IFishSpecies> = new Map();

    public async findById(id: string): Promise<IFishSpecies | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<IFishSpecies[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: IFishSpecies): Promise<void> {
