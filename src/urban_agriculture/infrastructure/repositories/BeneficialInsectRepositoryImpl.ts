/**
 * @file BeneficialInsectinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for BeneficialInsect in the infrastructure/repositories layer.
...
import { IBeneficialInsectRepository } from '../../domain/repositories/IBeneficialInsectRepository';
import { IBeneficialInsect } from '../../domain/models/BeneficialInsect';

/**
 * Concrete implementation of IBeneficialInsectRepository using abstract infrastructure.
 */
export class BeneficialInsectRepositoryImpl implements IBeneficialInsectRepository {
    private storage: Map<string, IBeneficialInsect> = new Map();

    public async findById(id: string): Promise<IBeneficialInsect | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<IBeneficialInsect[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: IBeneficialInsect): Promise<void> {
