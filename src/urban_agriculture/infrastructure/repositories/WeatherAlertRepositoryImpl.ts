/**
 * @file WeatherAlertinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for WeatherAlert in the infrastructure/repositories layer.
...
import { IWeatherAlertRepository } from '../../domain/repositories/IWeatherAlertRepository';
import { IWeatherAlert } from '../../domain/models/WeatherAlert';

/**
 * Concrete implementation of IWeatherAlertRepository using abstract infrastructure.
 */
export class WeatherAlertRepositoryImpl implements IWeatherAlertRepository {
    private storage: Map<string, IWeatherAlert> = new Map();

    public async findById(id: string): Promise<IWeatherAlert | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<IWeatherAlert[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: IWeatherAlert): Promise<void> {
