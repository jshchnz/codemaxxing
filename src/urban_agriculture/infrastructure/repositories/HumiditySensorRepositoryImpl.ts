/**
 * @file HumiditySensorinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for HumiditySensor in the infrastructure/repositories layer.
...
import { IHumiditySensorRepository } from '../../domain/repositories/IHumiditySensorRepository';
import { IHumiditySensor } from '../../domain/models/HumiditySensor';

/**
 * Concrete implementation of IHumiditySensorRepository using abstract infrastructure.
 */
export class HumiditySensorRepositoryImpl implements IHumiditySensorRepository {
    private storage: Map<string, IHumiditySensor> = new Map();

    public async findById(id: string): Promise<IHumiditySensor | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<IHumiditySensor[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: IHumiditySensor): Promise<void> {
