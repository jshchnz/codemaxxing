/**
 * @file SoilTestinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for SoilTest in the infrastructure/repositories layer.
...
import { ISoilTestRepository } from '../../domain/repositories/ISoilTestRepository';
import { ISoilTest } from '../../domain/models/SoilTest';

/**
 * Concrete implementation of ISoilTestRepository using abstract infrastructure.
 */
export class SoilTestRepositoryImpl implements ISoilTestRepository {
    private storage: Map<string, ISoilTest> = new Map();

    public async findById(id: string): Promise<ISoilTest | null> {
        return this.storage.get(id) || null;
    }

    public async findAll(): Promise<ISoilTest[]> {
        return Array.from(this.storage.values());
    }

    public async save(entity: ISoilTest): Promise<void> {
