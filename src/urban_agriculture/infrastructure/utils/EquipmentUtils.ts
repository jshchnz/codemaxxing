/**
 * @file Equipmentinfrastructure_utils.ts
 * @description Enterprise-grade implementation for Equipment in the infrastructure/utils layer.
...
/**
 * Enterprise Utility class for Equipment.
