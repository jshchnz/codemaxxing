/**
 * @file Eventinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for Event in the infrastructure/repositories layer.
...
/**
 * Concrete implementation of IEventRepository using abstract infrastructure.
 */
export class EventRepositoryImpl implements IEventRepository {
    ...
    public async save(entity: IEvent): Promise<void> {
