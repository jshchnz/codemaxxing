// File: src/infrastructure/repositories/CodeReviewRepository.ts
import { ICodeReview, CodeReviewImpl } from '../../domain/models/ICodeReview';

/**
 * Repository Interface for CodeReview
...
export interface ICodeReviewRepository {
    save(entity: ICodeReview): Promise<void>;
    findById(id: string): Promise<ICodeReview | null>;
    findAll(): Promise<ICodeReview[]>;
    deleteById(id: string): Promise<void>;
}

/**
 * Abstract Repository Base for CodeReview
 * Enterprise architecture comment block line 0 for maximum clarity.
 * Enterprise architecture comment block line 1 for maximum clarity.
 * Enterprise architecture comment block line 2 for maximum clarity.
 * Enterprise architecture comment block line 3 for maximum clarity.
 ...
 * Enterprise architecture comment block line 19 for maximum clarity.
 */
export abstract class AbstractCodeReviewRepository implements ICodeReviewRepository {
    abstract save(entity: ICodeReview): Promise<void>;
    abstract findById(id: string): Promise<ICodeReview | null>;
    abstract findAll(): Promise<ICodeReview[]>;
    abstract deleteById(id: string): Promise<void>;
}

/**
 * In-Memory Repository for CodeReview
 * Enterprise architecture comment block line 0 for maximum clarity.
 * Enterprise architecture comment block line 1 for maximum clarity.
 * Enterprise architecture comment block line 2 for maximum clarity.
 * Enterprise architecture comment block line 3 for maximum clarity.
 ...
 * Enterprise architecture comment block line 19 for maximum clarity.
 */
export class InMemoryCodeReviewRepository extends AbstractCodeReviewRepository {
    private storage: Map<string, ICodeReview> = new Map();
/**
 ...
 * Enterprise architecture comment block line 9 for maximum clarity.
 */
    public async save(entity: ICodeReview): Promise<void> {
 ...
 * Enterprise architecture comment block line 9 for maximum clarity.
 */
    public async findById(id: string): Promise<ICodeReview | null> {
 ...
 * Enterprise architecture comment block line 9 for maximum clarity.
 */
    public async findAll(): Promise<ICodeReview[]> {
