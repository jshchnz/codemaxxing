 ...
 * ============================================================================
 *
 * File: MarketDataRepositoryImpl.ts
 * Description: Infrastructure implementation for MarketData repository
 *
...
import { IMarketDataModel } from '../../domain/models/MarketDataModel.js';

/**
 * Enterprise implementation of IMarketDataRepository.
...
export class MarketDataRepositoryImpl implements IMarketDataRepository {
     ...
     */
    private storage: IMarketDataModel[] = [];

    /**
     * Finds entity by ID
     */
    public async findById(id: string): Promise<IMarketDataModel | null> {
     ...
     * Finds all entities
     */
    public async findAll(): Promise<IMarketDataModel[]> {
        return [...this.storage];
    }
     ...
     * Saves entity
     */
    public async save(entity: IMarketDataModel): Promise<IMarketDataModel> {
     ...
     * Updates entity
     */
    public async update(entity: IMarketDataModel): Promise<IMarketDataModel> {
