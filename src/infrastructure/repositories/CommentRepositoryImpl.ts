/**
 * @file Commentinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for Comment in the infrastructure/repositories layer.
...
/**
 * Concrete implementation of ICommentRepository using abstract infrastructure.
 */
export class CommentRepositoryImpl implements ICommentRepository {
    private storage: Map<string, IComment> = new Map();
    ...
    public async save(entity: IComment): Promise<void> {
