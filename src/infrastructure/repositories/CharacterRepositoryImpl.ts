/**
 * @file Characterinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for Character in the infrastructure/repositories layer.
...
/**
 * Concrete implementation of ICharacterRepository using abstract infrastructure.
 * Perfect for storing Character state during intense TTRPG sessions.
 */
export class CharacterRepositoryImpl implements ICharacterRepository {
    private storage: Map<string, ICharacter> = new Map();
    ...
    public async save(entity: ICharacter): Promise<void> {
    ...
    public async findByName(name: string): Promise<ICharacter[]> {
