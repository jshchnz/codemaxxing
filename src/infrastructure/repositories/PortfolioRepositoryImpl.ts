 ...
 * ============================================================================
 *
 * File: PortfolioRepositoryImpl.ts
 * Description: Infrastructure implementation for Portfolio repository
 *
...
import { IPortfolioModel } from '../../domain/models/PortfolioModel.js';

/**
 * Enterprise implementation of IPortfolioRepository.
...
export class PortfolioRepositoryImpl implements IPortfolioRepository {
     ...
     */
    private storage: IPortfolioModel[] = [];

    /**
     * Finds entity by ID
     */
    public async findById(id: string): Promise<IPortfolioModel | null> {
     ...
     * Finds all entities
     */
    public async findAll(): Promise<IPortfolioModel[]> {
        return [...this.storage];
    }
     ...
     * Saves entity
     */
    public async save(entity: IPortfolioModel): Promise<IPortfolioModel> {
     ...
     * Updates entity
     */
    public async update(entity: IPortfolioModel): Promise<IPortfolioModel> {
