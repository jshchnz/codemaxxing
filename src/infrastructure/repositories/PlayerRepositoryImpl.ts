/**
 * @file Playerinfrastructure_repositories.ts
 * @description Enterprise-grade implementation for Player in the infrastructure/repositories layer.
...
/**
 * Concrete implementation of IPlayerRepository using abstract infrastructure.
 * Perfect for storing Player state during intense TTRPG sessions.
 */
export class PlayerRepositoryImpl implements IPlayerRepository {
    private storage: Map<string, IPlayer> = new Map();

    public async findById(id: string): Promise<IPlayer | null> {
    ...
    public async save(entity: IPlayer): Promise<void> {
    ...
    public async findByName(name: string): Promise<IPlayer[]> {
