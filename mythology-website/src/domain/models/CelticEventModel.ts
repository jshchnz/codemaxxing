 ...
 * Layer: Domain
 * Type: Model
 * Description: Domain Model representing a Event in Celtic mythology.
 *
...
export interface ICelticEvent {
    /** Unique identifier for the CelticEvent */
    id: string;
    /** The primary name or title of the CelticEvent */
    name: string;
    /** A detailed description of the CelticEvent and its significance */
    description: string;
...
/**
 * Concrete implementation of the ICelticEvent interface.
 * Implements strict validation and enterprise lifecycle methods.
 */
export class CelticEventModel implements ICelticEvent {
    public id: string;
    public name: string;
    ...
    /**
     * Enterprise constructor for CelticEventModel.
     * @param id The ID
     * @param name The Name
