 ...
 * Layer: Domain
 * Type: Model
 * Description: Domain Model representing a Artifact in Celtic mythology.
 *
...
export interface ICelticArtifact {
    /** Unique identifier for the CelticArtifact */
    id: string;
    /** The primary name or title of the CelticArtifact */
    name: string;
    /** A detailed description of the CelticArtifact and its significance */
    description: string;
    /** The specific cultural origin, which is inherently Celtic */
    origin: string;
...
/**
 * Concrete implementation of the ICelticArtifact interface.
 * Implements strict validation and enterprise lifecycle methods.
 */
export class CelticArtifactModel implements ICelticArtifact {
    public id: string;
    public name: string;
    public description: string;
    public origin: string = "Celtic";
    public aliases: string[];
    public metadata: Record<string, any>;

    /**
     * Enterprise constructor for CelticArtifactModel.
     * @param id The ID
     * @param name The Name
