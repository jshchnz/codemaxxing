 ...
 * Layer: Domain
 * Type: Model
 * Description: Domain Model representing a Creature in Maori mythology.
 *
...
export interface IMaoriCreature {
    /** Unique identifier for the MaoriCreature */
    id: string;
    /** The primary name or title of the MaoriCreature */
    name: string;
    /** A detailed description of the MaoriCreature and its significance */
    description: string;
    /** The specific cultural origin, which is inherently Maori */
    origin: string;
...
/**
 * Concrete implementation of the IMaoriCreature interface.
 * Implements strict validation and enterprise lifecycle methods.
 */
export class MaoriCreatureModel implements IMaoriCreature {
    public id: string;
    public name: string;
    public description: string;
    public origin: string = "Maori";
    public aliases: string[];
    public metadata: Record<string, any>;

    /**
     * Enterprise constructor for MaoriCreatureModel.
     * @param id The ID
     * @param name The Name
