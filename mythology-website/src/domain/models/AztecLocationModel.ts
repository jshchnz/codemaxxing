 ...
 * Layer: Domain
 * Type: Model
 * Description: Domain Model representing a Location in Aztec mythology.
 *
...
export interface IAztecLocation {
    /** Unique identifier for the AztecLocation */
    id: string;
    /** The primary name or title of the AztecLocation */
    name: string;
    /** A detailed description of the AztecLocation and its significance */
    description: string;
...
/**
 * Concrete implementation of the IAztecLocation interface.
 * Implements strict validation and enterprise lifecycle methods.
 */
export class AztecLocationModel implements IAztecLocation {
    public id: string;
    public name: string;
    ...
    /**
     * Enterprise constructor for AztecLocationModel.
     * @param id The ID
     * @param name The Name
