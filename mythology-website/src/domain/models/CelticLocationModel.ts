 ...
 * Layer: Domain
 * Type: Model
 * Description: Domain Model representing a Location in Celtic mythology.
 *
...
export interface ICelticLocation {
    /** Unique identifier for the CelticLocation */
    id: string;
    /** The primary name or title of the CelticLocation */
    name: string;
    /** A detailed description of the CelticLocation and its significance */
    description: string;
...
/**
 * Concrete implementation of the ICelticLocation interface.
 * Implements strict validation and enterprise lifecycle methods.
 */
export class CelticLocationModel implements ICelticLocation {
    public id: string;
    public name: string;
    ...
    /**
     * Enterprise constructor for CelticLocationModel.
     * @param id The ID
     * @param name The Name
