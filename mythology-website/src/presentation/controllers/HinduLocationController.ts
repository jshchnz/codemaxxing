 ...
 * Layer: Presentation
 * Type: Controller
 * Description: Presentation Controller for HinduLocation.
 *
...
import { CreateHinduLocationUseCase, GetAllHinduLocationUseCase, GetHinduLocationByIdUseCase } from '../../application/repositories/HinduLocationUseCases';
import { CreateHinduLocationDTO } from '../../application/repositories/HinduLocationUseCases';

/**
 * Enterprise Controller for handling HinduLocation HTTP requests.
 * Acts as the primary ingress point for the Presentation Layer.
 */
export class HinduLocationController {
    private createUseCase: CreateHinduLocationUseCase;
    private getAllUseCase: GetAllHinduLocationUseCase;
    private getByIdUseCase: GetHinduLocationByIdUseCase;

    constructor(
        createUseCase: CreateHinduLocationUseCase,
        getAllUseCase: GetAllHinduLocationUseCase,
        getByIdUseCase: GetHinduLocationByIdUseCase
    ) {
    ...
    /**
     * Handles HTTP POST requests to create a new HinduLocation.
     */
    public async handleCreate(requestBody: any): Promise<any> {
        try {
            ...
            const dto: CreateHinduLocationDTO = {
    ...
    /**
     * Handles HTTP GET requests to fetch all HinduLocation entities.
     */
    ...
    /**
     * Handles HTTP GET requests to fetch a specific HinduLocation by ID.
     */
